/*
 Basic Primitives Diagram v4.1.0
...
e.name+".preventClickEvent",!0),null!=e.onMouseStop))e.onMouseStop(c);return!1}function d(a){return Math.max(Math.abs(f.pageX-a.pageX),Math.abs(f.pageY-a.pageY))>=e.distance}var e={distance:3,delay:0,element:null,name:null,onMouseStart:null,onMouseDrag:null,onMouseStop:null,onMouseCapture:null},f,g;return{init:function(h,i){e.element=h;for(var k in i)i.hasOwnProperty(k)&&(e[k]=i[k]);e.element.bind("mousedown."+e.name,function(j){a:if(primitives.common.Mouse.MouseHandled)j=void 0;else{g&&c(j);f=j;
var h=1===j.which,i=j.target.nodeName?jQuery(j.target).closest("input,textarea,button,select,option").length:!1;if(!(h=!h))i||(i=null!=e.onMouseCapture?e.onMouseCapture(j):!0,i=!i),h=i;if(!h){(mouseDelayMet=!e.delay)||(_mouseDelayTimer=setTimeout(function(){mouseDelayMet=!0},e.delay));if(d(j)&&mouseDelayMet){if(null!=e.onMouseStart)e.onMouseStart(j);g=!0;if(!g){j.preventDefault();j=!0;break a}}!0===jQuery.data(j.target,e.name+".preventClickEvent")&&jQuery.removeData(j.target,e.name+".preventClickEvent");
jQuery(document).bind("mousemove."+e.name,a).bind("mouseup."+e.name,b);j.preventDefault();primitives.common.Mouse.MouseHandled=!0}j=!0}return j}).bind("click."+e.name,function(a){if(!0===jQuery.data(a.target,e.name+".preventClickEvent"))return jQuery.removeData(a.target,e.name+".preventClickEvent"),a.stopImmediatePropagation(),!1})},destroy:function(){e.element.unbind("."+e.name);a&&jQuery(document).unbind("mousemove."+e.name,a).unbind("mouseup."+e.name,b)},isStarted:function(){return g}}};
primitives.common.Mouse.MouseHandled=!1;"undefined"!=typeof jQuery&&jQuery(document).mouseup(function(){primitives.common.Mouse.MouseHandled=!1});primitives.common.AdviserPlacementType={Auto:0,Left:2,Right:3};primitives.orgdiagram.AdviserPlacementType=primitives.common.AdviserPlacementType;primitives.common.NeighboursSelectionMode={ParentsAndChildren:0,ParentsChildrenSiblingsAndSpouses:1};primitives.common.OrientationType={Top:0,Bottom:1,Left:2,Right:3,None:4};
primitives.orgdiagram.OrientationType=primitives.common.OrientationType;primitives.common.PageFitMode={None:0,PageWidth:1,PageHeight:2,FitToPage:3,PrintPreview:4,AutoSize:5,SelectionOnly:6};primitives.orgdiagram.PageFitMode=primitives.common.PageFitMode;primitives.common.PlacementType={Auto:0,TopLeft:8,Top:1,TopRight:2,RightTop:11,Right:3,RightBottom:12,BottomRight:4,Bottom:5,BottomLeft:6,LeftBottom:10,Left:7,LeftTop:9};primitives.common.QuadrantType={TopLeft:0,TopRight:1,BottomLeft:2,BottomRight:3};
primitives.common.RenderingMode={Create:0,Update:1};primitives.common.NavigationMode={Default:0,CursorOnly:1,HighlightOnly:3,Inactive:2};primitives.common.SegmentType={Line:0,Move:1,QuadraticArc:2,CubicArc:3,Dot:4};primitives.common.ShapeType={Rectangle:0,Oval:1,Triangle:2,CrossOut:3,Circle:4,Rhombus:5,Wedge:7,FramedOval:8,FramedTriangle:9,FramedWedge:10,FramedRhombus:11,None:6};primitives.common.SideFlag={Top:1,Right:2,Bottom:4,Left:8};
primitives.text.TextOrientationType={Horizontal:0,RotateLeft:1,RotateRight:2,Auto:3};primitives.common.UpdateMode={Recreate:0,Refresh:1,PositonHighlight:2};primitives.orgdiagram.UpdateMode=primitives.common.UpdateMode;primitives.common.VectorRelationType={None:0,Null:1,Collinear:2,Opposite:3};primitives.common.VerticalAlignmentType={Top:0,Middle:1,Bottom:2};primitives.common.SelectionPathMode={None:0,FullStack:1};primitives.orgdiagram.SelectionPathMode=primitives.common.SelectionPathMode;
primitives.common.Visibility={Auto:0,Normal:1,Dot:2,Line:3,Invisible:4};primitives.common.LineType={Solid:0,Dotted:1,Dashed:2};primitives.common.LabelType={Regular:0,Dummy:1,Fixed:2};primitives.common.AnnotationType={Connector:0,Shape:1,HighlightPath:2,Label:3,Background:4};primitives.common.ChildrenPlacementType={Auto:0,Vertical:1,Horizontal:2,Matrix:3};primitives.orgdiagram.ChildrenPlacementType=primitives.common.ChildrenPlacementType;
...
LightSteelBlue:"#b0c4de",LightYellow:"#ffffe0",Lime:"#00ff00",Limegreen:"#32cd32",Linen:"#faf0e6",Magenta:"#ff00ff",Maroon:"#800000",MediumAquamarine:"#66cdaa",MediumBlue:"#0000cd",MediumOrchid:"#ba55d3",MediumPurple:"#9370d8",MediumSeaGreen:"#3cb371",MediumSlateBlue:"#7b68ee",MediumSpringGreen:"#00fa9a",MediumTurquoise:"#48d1cc",MediumVioletRed:"#c71585",MidnightBlue:"#191970",MintCream:"#f5fffa",MistyRose:"#ffe4e1",Moccasin:"#ffe4b5",NavajoWhite:"#ffdead",Navy:"#ffffff",Oldlace:"#fdf5e6",Olive:"#808000",
...
primitives.common.Layers={PrintPreview:1,BackgroundAnnotation:2,BackgroundAnnotations:3,BackgroundConnectorAnnotation:4,BackgroundHighlightPathAnnotations:5,Connector:6,ForegroundHighlightPathAnnotations:7,Highlight:8,Marker:9,Label:10,Cursor:11,Item:12,ForegroundAnnotations:13,ForegroundConnectorAnnotation:14,Annotation:15,Controls:16};primitives.common.ConnectorStyleType={Extra:0,Regular:1,Highlight:2};primitives.common.ElbowType={None:0,Dot:1,Bevel:2,Round:3};
primitives.common.Enabled={Auto:0,True:1,False:2};primitives.common.GraphicsType={SVG:0,Canvas:1,VML:2};primitives.common.GroupByType={None:0,Parents:1,Children:2};primitives.common.HorizontalAlignmentType={Center:0,Left:1,Right:2};primitives.orgdiagram.ItemType={Regular:0,Assistant:1,SubAssistant:4,SuperAssistant:10,SuperAdviser:9,SubAdviser:5,Adviser:2,Director:11,GeneralPartner:6,LimitedPartner:7,AdviserPartner:8};primitives.common.ConnectorType={Squared:0,Angular:1,Curved:2};
...
primitives.common.Callout.prototype._drawSegment=function(a,b,c,d,e,f,g,h){var i=this._offsetPoint(b,c,f),k=this._offsetPoint(c,b,f),d=this._offsetPoint(c,d,f),e=this.m_graphics.getPxSize(e,b.distanceTo(c)/2);0===a.length()&&a.addSegment(new primitives.common.MoveSegment(i));null!==g&&(i=this._betweenPoint(b,c),b=this._offsetPoint(i,b,e),e=this._offsetPoint(i,c,e),a.addSegment(new primitives.common.LineSegment(b)),a.addSegment(new primitives.common.LineSegment(g)),a.addSegment(new primitives.common.LineSegment(e)));
a.addSegment(new primitives.common.LineSegment(k));null!==h?(a.addSegment(new primitives.common.LineSegment(h)),a.addSegment(new primitives.common.LineSegment(d))):a.addSegment(new primitives.common.QuadraticArcSegment(c,d))};primitives.common.ConnectorOffbeat=function(){};primitives.common.ConnectorOffbeat.prototype=new primitives.common.BaseShape;
primitives.common.ConnectorOffbeat.prototype.draw=function(a,b,c,d,e,f,g,h,i,k,j,l,m,n){var s,q,p,r,w,x,t,u,m=f=0,z=null,v,y;v=a.getPolyline(b);w=[];switch(i){case 1:w=[-e/2,e/2];y=!1;break;case 0:w=[0];y=!1;break;case 2:w=[0],y=!0}s=Math.max(l?g.width:0,5*e);if(c.right()+s<d.left()||c.left()>d.right()+s)if(c.left()>d.right()?(p=new primitives.common.Point(c.left(),c.verticalCenter()),r=new primitives.common.Point(d.right(),d.verticalCenter())):(p=new primitives.common.Point(c.right(),c.verticalCenter()),
r=new primitives.common.Point(d.left(),d.verticalCenter())),l&&(c.left()>d.right()?(f=7,m=3):(f=3,m=7)),q=new primitives.common.Rect(p,r),u=p.y<=r.y,t=p.x<r.x,q.height<q.width){q.height<2*e&&q.offset(0,u?2*e:0,0,u?0:2*e);h=0;for(s=w.length;h<s;h+=1)x=w[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+x));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),(u?q.top():q.bottom())+x,r.x,r.y+x));y&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},
h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(i=g.width<2*(q.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,q.horizontalCenter(),u?q.top():q.bottom(),r.x,r.y,0.5):new primitives.common.Point(p.x,u?q.top():q.bottom()),z=new primitives.common.Rect(i.x+(t?e:-g.width-e),u?i.y-g.height-e:i.y+e,g.width,g.height))}else{h=0;for(s=w.length;h<s;h+=1)x=w[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,
p.y+x));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+x*(u!=t?1:-1),(u?q.top():q.bottom())+x,q.horizontalCenter()+x*(u!=t?1:-1),q.verticalCenter()+x));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+x*(u!=t?1:-1),(u?q.bottom():q.top())+x,r.x,r.y+x));y&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(z=new primitives.common.Rect(q.horizontalCenter()+
(u!=t?e:-(e+g.width)),q.verticalCenter()-g.height/2,g.width,g.height))}else if(c.verticalCenter()<d.top()||c.verticalCenter()>d.bottom()){t=c.x<h.width/2;p=new primitives.common.Point(t?c.right():c.left(),c.verticalCenter());r=new primitives.common.Point(t?d.right():d.left(),d.verticalCenter());q=new primitives.common.Rect(p,r);q.offset(10*e,0,10*e,0);u=p.y<=r.y;h=0;for(s=w.length;h<s;h+=1)x=w[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+x));
c.addSegment(new primitives.common.QuadraticArcSegment(t?q.right()+x*(u?-1:1):q.left()-x*(u?-1:1),q.verticalCenter(),t?d.right():d.left(),d.verticalCenter()-x));y&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=t?3:7,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,t?q.right():q.left(),q.verticalCenter(),r.x,r.y,0.5),z=new primitives.common.Rect(i.x+(t?
e/2:-e/2-g.width),i.y-g.height/2,g.width,g.height))}else{p=new primitives.common.Point(c.horizontalCenter(),c.top());r=new primitives.common.Point(d.horizontalCenter(),d.top());q=new primitives.common.Rect(p,r);q.offset(0,7*e,0,0);t=p.x<r.x;h=0;for(s=w.length;h<s;h+=1)x=w[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x+x,p.y));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),q.top()-x*(t?-1:1),d.horizontalCenter()-x,d.top()));
y&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=1,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,q.horizontalCenter(),q.top(),r.x,r.y,0.5),z=new primitives.common.Rect(i.x-g.width/2,i.y-(k+g.height),g.width,g.height))}if(l)switch(j){case 0:z=this._getLabelPosition(c.x,c.y,c.width,c.height,z.width,z.height,k,f);break;case 2:z=this._getLabelPosition(d.x,
d.y,d.width,d.height,z.width,z.height,k,m)}null!=n&&n(z)};primitives.common.ConnectorStraight=function(){};primitives.common.ConnectorStraight.prototype=new primitives.common.BaseShape;
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,k,j,l,m,n){var s,q,p,r,w,x=e/2,t=null,u=0,z=0,v=this;r=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){s=a.getIntersectionPoint(r,!0,1);u=b;return null!=s});d.loopEdges(function(a,b){q=a.getIntersectionPoint(r,!0,1);z=b;return null!=q});if(null!=s&&null!=q){var y=new primitives.common.Vector(s,q);m.getOffset(y,function(c,d,e){y.offset((c*f-(d-1)*f/2)*e);s=y.from;q=y.to;switch(i){case 1:w=
new primitives.common.Vector(q.clone(),s.clone());w.offset(x);v._drawLine(a,b,w.from,w.to,!1);w=new primitives.common.Vector(s.clone(),q.clone());w.offset(x);v._drawLine(a,b,w.from,w.to,!1);break;case 0:v._drawLine(a,b,s,q,!1);break;case 2:v._drawLine(a,b,s,q,!0)}if(l){switch(j){case 0:t=v._getLabelPositionBySnapPoint(s.x,s.y,g.width,g.height,k,u);break;case 1:p=v._betweenPoint(s,q);t=v._getLabelPositionBySnapPoint(p.x,p.y,g.width,g.height,k,3);break;case 2:t=v._getLabelPositionBySnapPoint(q.x,q.y,
g.width,g.height,k,z)}null!=n&&n.call(this,t)}})}};primitives.common.ConnectorStraight.prototype._drawLine=function(a,b,c,d,e){var f;a.addInverted(function(e){f=e.getPolyline(b);f.addSegment(new primitives.common.MoveSegment(c));f.addSegment(new primitives.common.LineSegment(d));f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},!1);e&&(f=a.getPolyline(b),f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))}))};
...
primitives.common.Perimeter.prototype.draw=function(a){var b=new primitives.common.PaletteItem({lineColor:this.borderColor,lineWidth:this.lineWidth,fillColor:this.fillColor,lineType:this.lineType,opacity:this.opacity}),c=new primitives.common.Polyline(b),d=this.lineWidth/2,e=null,f=null,g=null,h={};a.segments.iterate(function(b){var k=0,j=0,l=!1;if(0<d)switch(b.orientationType){case 3:k=-d;l=!1;break;case 2:k=d;l=!1;break;case 0:j=d;l=!0;break;case 1:j=-d;l=!0;break;default:throw"Orientation is not defined!";
}0===c.length()&&(f=new primitives.common.MoveSegment(b.fromPoint),c.addSegment(f),h[a.segments.endKey()]={point:f,isVertical:l});k=null!=a.segments.item(b.oppositeKey)?new primitives.common.MoveSegment(b.toPoint.x+k,b.toPoint.y+j):new primitives.common.LineSegment(b.toPoint.x+k,b.toPoint.y+j);c.addSegment(k);0<d&&(l?f.y=k.y:f.x=k.x,null!=e&&(!a.segments.item(e.oppositeKey)&&null!=a.segments.item(b.oppositeKey)?h.hasOwnProperty(b.oppositeKey)?(j=h[b.oppositeKey],j.isVertical?f.y=j.point.y:f.x=j.point.x,
g?j.point.y=f.y:j.point.x=f.x):h[b.oppositeKey]={point:f,isVertical:g}:null!=a.segments.item(e.oppositeKey)&&!a.segments.item(b.oppositeKey)&&(h.hasOwnProperty(e.key)?(j=h[e.key],j.isVertical?f.y=j.point.y:f.x=j.point.x,g?j.point.y=f.y:j.point.x=f.x):h[e.key]={point:f,isVertical:l})),g=l,e=b);f=k});0<d&&!a.segments.item(e.oppositeKey)&&(b=h[e.key],b.isVertical?f.y=b.point.y:f.x=b.point.x,g?b.point.y=f.y:b.point.x=f.x);c.transform(this.transform,!0);this.m_graphics.polyline(c)};
...
primitives.common.Polyline=function(a){function b(a,b){var c,d,f;if(null!=b){c=0;for(d=i.length;c<d&&(!(f=i[c])||!b.call(a,f,c));c+=1);}}function c(){return primitives.common.isNullOrEmpty(h.fillColor)}function d(a,b,c,d,f,e){for(var g=new primitives.common.Polyline(j),h,i,f=[new primitives.common.Point(f,-e/2),new primitives.common.Point(0,0),new primitives.common.Point(f,e/2),new primitives.common.Point(3*(f/4),0)],k=Math.atan2(b-d,a-c),a=0,b=f.length;a<b;a+=1)e=f[a],h=e.x*Math.cos(k)-e.y*Math.sin(k),
i=e.x*Math.sin(k)+e.y*Math.cos(k),e.x=h+c,e.y=i+d;g.addSegment(new primitives.common.MoveSegment(f[0].x,f[0].y));g.addSegment(new primitives.common.LineSegment(f[1].x,f[1].y));g.addSegment(new primitives.common.LineSegment(f[2].x,f[2].y));g.addSegment(new primitives.common.QuadraticArcSegment(f[3].x,f[3].y,f[0].x,f[0].y));return g}function e(a,b){this.segment=a;this.pointIndex=b}function f(a,b,c,d,f){var g=a.relateTo(b),j=f?0:c;2==g?b.offset(j):3==g&&0===b.from.context.pointIndex?(g=new primitives.common.LineSegment(b.from),
d.addSegment(g),b.offset(j),d=b.from.clone(),d.context=new e(g,0),j=new primitives.common.Vector(a.to.clone(),d),f||(b.from=d.clone()),j.offset(c),j.intersect(a),j.from.context.pushToSegment(j.from),b.intersect(j),f&&j.to.context.pushToSegment(j.to)):(b.offset(j),b.intersect(a));b.from.context.pushToSegment(b.from)}function g(a,b,c,d){var e,g=a[0],j=g.to.context.segment.getEndPoint().toString();b.hasOwnProperty(j)&&(e=b[j],f(g,e,c,d,!0),delete b[j]);g.to.context.pushToSegment(g.to);a.length=0}var h=
new primitives.common.PaletteItem,i=[],k,j;switch(arguments.length){case 1:h=a}j=new primitives.common.PaletteItem({lineColor:h.lineColor,lineWidth:0,fillColor:h.lineColor,opacity:h.opacity||1});e.prototype.pushToSegment=function(a){this.segment.setPoint(a,this.pointIndex)};return k={paletteItem:h,arrowPaletteItem:j,addSegment:function(a){i.push(a)},addSegments:function(a){i=i.concat(a)},mergeTo:function(a){a.addSegments(i)},length:function(){return i.length},loop:b,loopReversed:function(a,b){var c,
d;if(null!=b)for(c=i.length-1;0<=c&&(!(d=i[c])||!b.call(a,d,c));c-=1);},transform:function(a,c){b(this,function(b){null!=b.transform&&b.transform(a,c)})},isInvertable:c,addInverted:function(a){var b=!1,d=[];c()?a.loopReversed(this,function(a){4!=a.segmentType&&(b||(i.push(new primitives.common.MoveSegment(a.getEndPoint())),b=!0),d.unshift(a),1<d.length&&(d[1].invert(d[0].getEndPoint()),i.push(d[1]),d.length=1))}):a.mergeTo(k)},addArrow:function(a,b){var c,f,e,g;f=i.length;g=3*a;var j=2*a;switch(a){case 1:g=
8;j=6;break;case 2:g=12;j=8;break;case 3:g=16,j=10}null!=b&&1<f&&(c=i[f-2].getEndPoint(),e=i[f-1],null!=e.trim&&(f=new primitives.common.Point(e.getEndPoint()),c=e.trim(c,j),g=d(c.x,c.y,f.x,f.y,g,j),b(g,c)))},addOffsetArrow:function(a,b,c,f,e){var g,j,h;g=i.length;h=3*b;var k=2*b,t;switch(b){case 1:h=8;k=6;break;case 2:h=12;k=8;break;case 3:h=16,k=10}null!=e&&1<g&&(b=i[g-2].getEndPoint(),j=i[g-1],null!=j.offsetPoint&&(g=new primitives.common.Point(j.getEndPoint()),t=b.distanceTo(g),t>f&&(c*=t,a?(a=
j.offsetPoint(b,g,c),h=d(b.x,b.y,a.x,a.y,h,k)):(a=j.offsetPoint(g,b,c),h=d(g.x,g.y,a.x,a.y,h,k)),e(h))))},optimizeMoveSegments:function(){var a,b,c,d,f;c={};var e=[],g=[];a=0;for(b=i.length;a<b-1;a+=1)switch(d=i[a],f=i[a+1],d.segmentType){case 0:case 2:case 3:switch(f.segmentType){case 1:case 4:d=d.x+"&"+d.y,c.hasOwnProperty(d)||(c[d]=a)}break;case 1:d=d.x+"&"+d.y,c.hasOwnProperty(d)&&!e[c[d]]&&(e[c[d]]=a+1,g[a]=!0)}f=[];for(a=0;a<b;a+=1)if(!g[a]&&(d=i[a],f.push(d),g[a]=!0,0<e[a]))for(c=e[a];c<b&&
!g[c];)d=i[c],f.push(d),g[c]=!0,c=0<e[c]?e[c]:c+1;i=f},getOffsetPolyine:function(a){var c=new primitives.common.Polyline(h),d={},j=[],i=[];b(this,function(b){var h=b.clone();switch(h.segmentType){case 4:case 1:0<i.length&&g(i,d,a,c);j.length=0;1==h.segmentType&&(b=new primitives.common.Point(h),b.context=new e(h,0),j.push(b));break;default:h.loop(this,function(b,g,k){b=new primitives.common.Point(b,g);b.context=new e(h,k);j.unshift(b);1<j.length&&(i.unshift(new primitives.common.Vector(j[1].clone(),
j[0].clone())),j.length=1);switch(i.length){case 1:k=i[0];b=k.from.toString();d[b]=k;k.offset(a);k.from.context.pushToSegment(k.from);break;case 2:b=i[1],k=i[0],f(b,k,a,c,!1),i.length=1}})}c.addSegment(h)});0<i.length&&g(i,d,a,c);return c},toString:function(){return h.toString()},getStartPoint:function(){var a=null;0<i.length&&(a=i[0].getEndPoint());return a},getEndPoint:function(){var a=null;0<i.length&&(a=i[i.length-1].getEndPoint());return a},clone:function(){var a,b,c=new primitives.common.Polyline(h),
...
"solid 1px black");a=this.m_cache.get(k.name,k.activeLayer.name,"text");null===a?(a=jQuery("<div></div>"),a.css(g),a.html(e),k.activeLayer.canvas.append(a),this.m_cache.put(k.name,k.activeLayer.name,"text",a)):(a.css(g),a.html(e));break;default:g["border-collapse"]="collapse",b={"vertical-align":this._getVerticalAlignment(h),padding:0},this.debug&&(b.border="solid 1px black"),a=this.m_cache.get(k.name,k.activeLayer.name,"textintable"),null===a?(a=jQuery("<table><tbody><tr><td></td></tr></tbody></table>"),
primitives.common.css(a,g),a.find("td").css(b).html(e),k.activeLayer.canvas.append(a),this.m_cache.put(k.name,k.activeLayer.name,"textintable",a)):(primitives.common.css(a,g),a.find("td").css(b).html(e))}};primitives.common.Graphics.prototype._getTextAlign=function(a){var b=null;switch(a){case 0:b="center";break;case 1:b="left";break;case 2:b="right"}return b};
...
primitives.common.Graphics.prototype.template=function(a,b,c,d,e,f,g,h,i,k,j,l,m){var c=this.m_activePlaceholder,d="template"+(null!==k?k:primitives.common.hashCode(i)),n=0,k=this.m_cache.get(c.name,c.activeLayer.name,d);null!==m&&void 0!==m["border-width"]&&(n=this.getPxSize(m["border-width"]));a={width:g-n+"px",height:h-n+"px",top:b+f+"px",left:a+e+"px"};jQuery.extend(a,m);null==l&&(l=new primitives.common.RenderEventArgs);null==k?(k=jQuery(i),jQuery.extend(a,{position:"absolute",padding:"0px",
margin:"0px"},m),primitives.common.css(k,a),l.element=k,l.renderingMode=0,null!==j&&j(null,l),c.activeLayer.canvas.append(k),this.m_cache.put(c.name,c.activeLayer.name,d,k)):(l.element=k,l.renderingMode=1,primitives.common.css(k,a),null!==j&&j(null,l));return k};primitives.common.Graphics.prototype.getPxSize=function(a,b){var c=a;"string"===typeof a&&(c=0<a.indexOf("pt")?96*parseInt(a,10)/72:0<a.indexOf("%")?parseFloat(a)/100*b:parseInt(a,10));return c};
...
primitives.common.VmlGraphics.prototype.text=function(a,b,c,d,e,f,g,h,i){var k,j,l;switch(f){case 0:case 3:this.parent.text.call(this,a,b,c,d,e,f,g,h,i);break;default:k=this.m_activePlaceholder;f=1===f;a=new primitives.common.Rect(a,b,c,d);d=new primitives.common.Rect(0,0,10*c,10*d);c=new primitives.common.Element(this.prefix+":shape");c.setAttribute("CoordSize",d.width+","+d.height);c.setAttribute("filled",!0);c.setAttribute("stroked",!1);c.setAttribute("fillcolor",i["font-color"]);c.style.top=a.y+
"px";c.style.left=a.x+"px";c.style.width=a.width+"px";c.style.height=a.height+"px";c.style["font-family"]=i["font-family"];a=new primitives.common.Element(this.prefix+":path");a.setAttribute("TextPathOk",!0);b=16*Math.floor(this.getPxSize(i["font-size"]))*Math.max(e.split("\n").length-1,1);l=j=null;if(f)switch(h){case 0:j=new primitives.common.Point(d.x+b/2,d.bottom());l=new primitives.common.Point(d.x+b/2,d.y);break;case 1:j=new primitives.common.Point(d.horizontalCenter(),d.bottom());l=new primitives.common.Point(d.horizontalCenter(),
d.y);break;case 2:j=new primitives.common.Point(d.right()-b/2,d.bottom()),l=new primitives.common.Point(d.right()-b/2,d.y)}else switch(h){case 0:j=new primitives.common.Point(d.right()-b/2,d.y);l=new primitives.common.Point(d.right()-b/2,d.bottom());break;case 1:j=new primitives.common.Point(d.horizontalCenter(),d.y);l=new primitives.common.Point(d.horizontalCenter(),d.bottom());break;case 2:j=new primitives.common.Point(d.x+b/2,d.y),l=new primitives.common.Point(d.x+b/2,d.bottom())}a.setAttribute("v",
" m"+j.x+","+j.y+" l"+l.x+","+l.y+" e");h=new primitives.common.Element(this.prefix+":textpath");h.setAttribute("on",!0);h.setAttribute("string",e);h.style.trim=!1;h.style["v-text-align"]=this._getTextAlign(g);h.style.font="normal normal normal "+i["font-size"]+"pt "+i["font-family"];c.appendChild(a);c.appendChild(h);e=this.m_cache.get(k.name,k.activeLayer.name,"vmltext");null===e?(e=jQuery(c.create(this.ie8mode)),k.activeLayer.canvas.append(e),this.m_cache.put(k.name,k.activeLayer.name,"vmltext",
e)):c.update(e[0],this.ie8mode)}};
primitives.common.VmlGraphics.prototype.polyline=function(a){var b=this.m_activePlaceholder,c=new primitives.common.Rect(b.rect),d=new primitives.common.Rect(0,0,10*c.width,10*c.height),e=new primitives.common.Element(this.prefix+":shape"),f,g,h,i,k,j,l;g=a.paletteItem.toAttr();void 0!==g.borderColor&&void 0!==g.lineWidth?(e.setAttribute("strokecolor",g.borderColor),e.setAttribute("strokeweight",g.lineWidth),e.setAttribute("stroked",!0)):e.setAttribute("stroked",!1);e.setAttribute("CoordSize",d.width+
","+d.height);e.style.top=c.y+"px";e.style.left=c.x+"px";e.style.width=c.width+"px";e.style.height=c.height+"px";f="";a.loop(this,function(a){switch(a.segmentType){case 1:f+=" m"+10*Math.round(a.x)+","+10*Math.round(a.y);break;case 0:f+=" l"+10*Math.round(a.x)+","+10*Math.round(a.y);break;case 4:h=Math.round(a.x);i=Math.round(a.y);k=Math.round(a.x+a.width);j=Math.round(a.y+a.height);h>k&&(l=h,h=k,k=l);i>j&&(l=i,i=j,j=l);h=10*h+5;i=10*i+5;k=10*k-5;j=10*j-5;f+=" m"+h+","+i;f+=" l"+k+","+i;f+=" l"+k+
","+j;f+=" l"+h+","+j;f+=" l"+h+","+i;break;case 2:f+=" qb"+10*Math.round(a.cpX)+","+10*Math.round(a.cpY)+" l"+10*Math.round(a.x)+","+10*Math.round(a.y);break;case 3:f+=" c"+10*Math.round(a.cpX1)+","+10*Math.round(a.cpY1)+","+10*Math.round(a.cpX2)+","+10*Math.round(a.cpY2)+","+10*Math.round(a.x)+","+10*Math.round(a.y)}});f+=" e";a="shapepath";c=new primitives.common.Element(this.prefix+":path");c.setAttribute("v",f);e.appendChild(c);if(null!=g.lineType){c=new primitives.common.Element(this.prefix+
...
primitives.common.ArrayReader.prototype.read=function(a,b,c,d){var e=[],f={},g,h,i={},k={},j,l,m,n,s,q=c+"-seq";if(!b||!primitives.common.isArray(b))b=[];g=d.hash[c]||{};h=d.hash[q]||{};m=0;for(n=b.length;m<n;m+=1)j=b[m],l=this.containsUniqueItems?this.containsPrimitiveValues?j:j[this.uniquePropertyKey]:m,f.hasOwnProperty(l)||(s=this.itemTemplate.read(g[l]||{},j,c+"-"+m,d),e.push(s),f[l]=s,i[m]=l,this.createSourceHash&&(k[l]=j),this.isOrdered&&h[m]!=i[m]&&(d.isChanged=!0));d.hash[c]=f;d.hash[q]=i;
this.createSourceHash&&(d.sourceHash[c]=k);if(null==a||a.length!=e.length)d.isChanged=!0;return e};primitives.common.EnumerationReader=function(a,b,c){this.enumeration=a;this.isNullable=b;this.defaultValue=c;this.hash={};for(var d in a)this.hash[a[d]]=d};primitives.common.EnumerationReader.prototype.read=function(a,b,c,d){if(null===b||"undefined"==typeof b||!this.hash.hasOwnProperty(b))b=this.isNullable?null:this.defaultValue;a!==b&&(d.isChanged=!0);return b};primitives.common.FunctionReader=function(){};
...
this.onCursorChanged=this.onCursorChanging=this.onHighlightChanged=this.onHighlightChanging=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#ffffff";this.minimizedItemShapeType=6;this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.showNeigboursConnectorsHighlighted=!1;this.highlightLinesColor=
...
1;this.groupTitleHorizontalAlignment=0;this.groupTitleFontSize="14px";this.groupTitleFontFamily="Arial";this.groupTitleColor="#4169e1";this.groupTitleFontStyle=this.groupTitleFontWeight="bold";this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight=
"normal";this.enablePanning=!0;this.printPreviewPageSize=new primitives.common.Size(612,792);this.autoSizeMinimum=new primitives.common.Size(800,600);this.autoSizeMaximum=new primitives.common.Size(1024,768)};
...
!1,c.itemTitleColor),templateName:new primitives.common.ValueReader(["string"],!0)},!1),!1,null,!0);return{process:function(){var c={isChanged:!1,hash:g,sourceHash:{}},k=b.getMaximumId(),j,l,m;d=h.read(d,a.getAnnotations(3),"annotations",c);e={};var n=c.sourceHash.annotations;j=0;for(l=d.length;j<l;j+=1)m=d[j],k+=1,m.id=k,e[m.id]=n[j];f=k;return c.isChanged},getAnnotations:function(){return d},getMaximumId:function(){return f},getConfig:function(a){return e[a]}}};
...
primitives.famdiagram.NormalizeOptionTask=function(a,b){var c={},d={},e=new primitives.common.ObjectReader({groupByType:new primitives.common.EnumerationReader(primitives.common.GroupByType,!1,b.groupByType),alignBylevels:new primitives.common.ValueReader(["boolean"],!1,b.alignBylevels),hideGrandParentsConnectors:new primitives.common.ValueReader(["boolean"],!1,b.hideGrandParentsConnectors)});return{process:function(){var b={isChanged:!1,hash:d};c=e.read(c,a.getOptions(),"options",b);return b.isChanged},
getOptions:function(){return c}}};primitives.famdiagram.OptionsTask=function(a){return{process:function(){return!0},getOptions:a,description:"Raw options."}};
...
primitives.famdiagram.LabelAnnotationTemplateParamsTask=function(a,b,c){var d={};return{process:function(){var e=a.getOptions(),f=b.getAnnotations(),g,h;d={};g=0;for(h=f.length;g<h;g+=1){var i=f[g],k=new primitives.orgdiagram.TemplateParams,j=c.getTemplate(i.templateName,e.defaultLabelAnnotationTemplate,c.DefaultWidgetLabelAnnotationTemplateName);k.template=j;d[i.id]=k}return!0},getTemplateParams:function(a){return d[a]}}};
...
primitives.famdiagram.AddLabelAnnotationsTask=function(a,b){function c(a,b){var c=primitives.common.graph(),d={},e,j,l,m;if(0<b.length){m=0;for(e=b.length;m<e;m+=1)j=b[m],d.hasOwnProperty(j.fromItem)?d[j.fromItem].push(j):(d[j.fromItem]=[j],a.loopChildren(this,j.fromItem,function(b){c.addEdge(j.fromItem,b,new primitives.famdiagram.EdgeItem(j.fromItem,j.fromItem,b,b));return a.SKIP}),a.loopParents(this,j.fromItem,function(b){c.addEdge(b,j.fromItem,new primitives.famdiagram.EdgeItem(b,b,j.fromItem,
j.fromItem));return a.SKIP}));for(l in d)if(d.hasOwnProperty(l)){e=d[l];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(m=0;m<e.length;m+=1){j=e[m];for(var n=a,s=c,q=j.fromItem,p=j.toItems,r=void 0,w=!0,x=null,t=void 0,u=void 0,z=void 0,v=void 0,y=[],u=0,z=p.length;u<z;u+=1)if(t=p[u],r=s.edge(q,t),null!=r){if(null==x)x=r.getFar(t);else if(x!=r.getFar(t)){w=!1;break}y.push(r.getNear(t))}else{w=!1;break}if(w&&(v=new primitives.famdiagram.FamilyItem({id:j.id,isVisible:!0,isLevelNeutral:!0,
isActive:!1,itemConfig:j}),n.bundleParents(x,y,v.id,v)?(v.levelGravity=2,w=!0):n.bundleChildren(x,y,v.id,v)?(v.levelGravity=1,w=!0):n.bundleParents(x,p,v.id,v)?(v.levelGravity=2,w=!0):n.bundleParents(x,p,v.id,v)&&(v.levelGravity=1,w=!0),w)){u=0;for(z=p.length;u<z;u+=1)t=p[u],r=s.edge(q,t),r.setFar(t,v.id)}}}}}var d=null,e=null;return{process:function(f){var g=b.getLogicalFamily(),h=a.getAnnotations(),g=g.clone();c(g,h);d=g;e=a.getMaximumId();if(f&&!g.validate())throw"References are broken in family structure!";
return!0},getNavigationFamily:function(){return d},getMaximumId:function(){return e}}};
primitives.famdiagram.AddSpousesTask=function(a,b){var c=null,d=null;return{process:function(e){var f=b.getLogicalFamily(),g=b.getMaximumId(),h=a.getItems(),i=f=f.clone(),k,j,l,m,n,s,q,p;l=0;for(m=h.length;l<m;l+=1){n=h[l];p=n.spouses.slice(0);s=0;for(q=p.length;s<q;s+=1)k=[n.id,p[s]],i.hasCommonChild(k)||(g+=1,j=new primitives.famdiagram.FamilyItem({id:g,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+g,description:"This is fake child keeps spouses together."},
levelGravity:1}),i.add(k,j.id,j))}c=f;d=g;if(e&&!f.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return c},getMaximumId:function(){return d}}};
primitives.famdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,k,j,l){function m(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(A.orientationType){case 2:case 3:a.invert()}if(!y.isEmpty())switch(C.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=n(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(C.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}y.loopLevelsReversed(this,function(a){var b;
for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=n(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=n(c,0);if(!s(b,f)&&(a=0,b=n(c,c.length-1),s(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=n(c,g),s(b,f)?e=g:a=g;e!==g&&(b=n(c,e))}}return b}function n(a,b){var c,d;z.treeLevelsPositions=[];y.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;z.treeLevelsPositions.push(a)});for(c=0;c<=b;c+=1)d=a[c],
z.treeLevelsPositions[d.level].currentvisibility=d.currentvisibility;r();t();w();c=C.lineLevelShift;var f,e,g,j,l=d=0;f=8*B.linesWidth;switch(B.arrowsDirection){case 1:d=f;l=0;break;case 2:d=0,l=f}f=0;for(e=z.treeLevelsPositions.length;f<e;f+=1)g=z.treeLevelsPositions[f],j=h.getConnectorsStacksSizes(f),c+=g.setShift(c,x(g.actualVisibility),l,d,j.parentsStackSize);return new primitives.common.Rect(0,0,Math.round(p()),Math.round(q()))}function s(a,b){var c=!1;switch(C.pageFitMode){case 1:b.width>=a.width&&
(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function q(){var a=z.treeLevelsPositions[z.treeLevelsPositions.length-1];return a.shift+a.nextLevelShift}function p(){var a=0;y.loopLevels(this,function(b){var c=y.getLevelLength(b);0<c&&(b=y.getItemAtPosition(b,c-1),b=z.treeItemsPositions[b],a=Math.max(a,b.offset+b.actualSize.width+b.rightPadding))});return a}function r(){var a=j.getCursorTreeItem();z.treeItemsPositions={};y.loopLevels(this,
function(b){var c=z.treeLevelsPositions[b];y.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=l.isItemSelected(b)?1:!d.isVisible?4:0,g=k.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==b,g,C,A);z.treeItemsPositions[b]=f})})}function w(){var a,b;y.loopLevels(this,function(c){var d=z.treeLevelsPositions[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;y.loopLevelItems(this,c,function(c){c=z.treeItemsPositions[c];d.depth=Math.max(d.depth,
c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&(a=b);switch(C.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function x(a){var b=
0;switch(a){case 1:b=C.normalLevelShift;break;case 2:b=C.dotLevelShift;break;case 3:case 4:b=C.lineLevelShift}return b}function t(){var a,b;a=0;for(b=z.treeLevelsPositions.length;a<b;a+=1)z.treeLevelsPositions[a].currentOffset=0;var c=y;a=v.getPlanarFamily(y);var d=new primitives.common.FamilyAlignment(this,a,c,function(a){var a=z.treeItemsPositions[a],b=i.getInterval(a.actualVisibility)/2;a.leftPadding=b;a.rightPadding=b;return a.leftPadding+a.actualSize.width+a.rightPadding}),f=null;c.loopLevels(this,
function(a){a=c.getItemAtPosition(a,0);if(null!=a){var b=z.treeItemsPositions[a],a=d.getOffset(a)-b.leftPadding-b.actualSize.width/2;f=null==f?a:Math.min(f,a)}});c.loopLevels(this,function(a){c.loopLevelItems(this,a,function(a){var b=z.treeItemsPositions[a],a=d.getOffset(a);b.offset=a-b.actualSize.width/2;b.offset-=f})})}function u(){y.loopLevels(this,function(a){var b=z.treeLevelsPositions[a];y.loopLevelItems(this,a,function(a){z.treeItemsPositions[a].setPosition(b,C,A)})})}var z={treeItemsPositions:{},
treeLevelsPositions:[],panelSize:null},v,y,A,B,C,D;return{process:function(){var j;C=d.getOptions();A=c.getOptions();B=e.getOptions();f.getOptions();v=g.getLogicalFamily();y=h.getTreeLevels();z.treeLevelsPositions=[];z.treeItemsPositions={};j=a.getOptimalPanelSize();D=b.getOptions();j.scale(1/D.scale);j=new primitives.common.Rect(0,0,j.width,j.height);z.panelSize=m(j);u();return!0},getTreeLevelsPositions:function(){return z.treeLevelsPositions},getItemsPositions:function(){return z.treeItemsPositions},
getItemPosition:function(a){return z.treeItemsPositions[a]},getContentSize:function(){return z.panelSize}}};
primitives.famdiagram.LevelsTask=function(a,b,c){var d,e,f,g,h;function i(a){var b,c,f,e,g,h,i,m,q=[],u,z,t,w,J,O,Z,$,ga,ha,ka,W=[],ja;if(0<a.hasNodes()){ka={};z=0;ja=[];a.loopRoots(this,function(b){var c=t=new primitives.famdiagram.Family(z),d,f=[],e,g,b=a.node(b),f=s(b.id,null,c.id,b.level,b.itemConfig);f.hideParentConnection=!0;f.isVisible=b.isVisible;f.isActive=b.isActive;f.hideParentConnection=b.hideParentConnection;f.hideChildrenConnection=b.hideChildrenConnection;c.items.push(f);ka[b.id]=!0;
b.familyId=c.id;for(f=n(b,a,ka,c);0<f.length;){e=[];b=0;for(d=f.length;b<d;b+=1)g=f[b],e=e.concat(n(g,a,ka,c));f=e}W.push(t);ja.push(t);z+=1});ja.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});q=[];u={};if(0<W.length){g=primitives.common.graph();b=0;for(c=W.length;b<c;b+=1){t=W[b];f=0;for(e=t.links.length;f<e;f+=1)h=t.links[f],m=a.node(h.fromItem).familyId,i=a.node(h.toItem).familyId,m!=i&&(g.addEdge(m,i,{weight:0}),g.edge(m,i).weight+=
1),W[i].backLinks.push(new primitives.famdiagram.FamLink(h.toItem,h.fromItem))}for(;q.length<W.length;){b=0;for(c=ja.length;b<c;b+=1)t=ja[b],u.hasOwnProperty(t.id)||(ga=g.getSpanningTree(t.id,function(a){return-a.weight}),null!=ga.node(t.id)?(ga.loopPostOrder(this,function(a,b,c){var b=W[a],d=W[c],f=[];null!=c&&(d.familyPriority+=b.familyPriority);f=[];ga.loopChildren(this,a,function(a){f.push(a)});f.sort(function(a,b){return W[a].familyPriority-W[b].familyPriority});ga.arrangeChildren(a,f)}),ga.loopPreOrder(this,
function(a){q.push(a);u[a]=!0})):(q.push(t.id),u[t.id]=!0))}}d+=1;m=s(d,null,null,x-1,null);m.hideParentConnection=!0;m.hideChildrenConnection=!0;m.title="internal root";m.isVisible=!1;m.isActive=!1;m.childIndex=0;e={};b=0;for(c=q.length;b<c;b+=1){t=W[q[b]];Z={};g=m;$=0;i=t.links.concat(t.backLinks);for(f=0;f<i.length;f+=1)h=i[f],J=p.node(h.toItem),p.node(h.fromItem),!0===e[J.familyId]&&(w=t.items[0],O=J,O.level>=w.level&&p.loopParents(this,O.id,function(a,b){O=b;if(b.level<w.level)return!0}),Z[O.id]=
Z.hasOwnProperty(O.id)?Z[O.id]+1:1,$<Z[O.id]&&(g=O,$=Z[O.id]));f=t;h=void 0;i=f.items[0];J=null;J=g;for(h=g.level+1;h<i.level;h+=1)d+=1,J=s(d,J.id,null,h,null),J.title="shift",J.isVisible=!1,J.isActive=!1,J.hideParentConnection=!0,J.hideChildrenConnection=!0,f.items.push(J);i.hideParentConnection=!0;p.adopt(J.id,i.id,i);e[t.id]=!0}b={};for(ha in r)if(r.hasOwnProperty(ha)){c=p.node(ha);m=r[ha];e=0;for(g=m.length;e<g;e+=1)f=p.node(m[e]),l(b,f,c)}ha=k();j(p,b,ha)}}function k(){var a={};p.loopPostOrder(this,
function(b,c,d){x=null!=x?Math.min(x,c.level):c.level;t=null!=t?Math.max(t,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function j(a,b,c){var d,f,e,g,j,h,l,i,k,m,n;a.loopLevels(this,function(s,q){var p=primitives.common.graph(),u={},t=null,z;l=[];a.loopChildren(this,q.id,function(c,e,g){var l;null==t&&(t=e);u[e.id]={};if(b.hasOwnProperty(e.id))for(l in h=
b[e.id],h)if(h.hasOwnProperty(l)){m=h[l];u[e.id][l]={};d=0;for(f=m.length;d<f;d+=1)j=m[d],z=j.commonParent==q.id?j.toParent:a.node(j.fromParent).childIndex<a.node(j.toParent).childIndex?"__right__":"__left__",e.id!=z&&(p.addEdge(e.id,z,{weight:0}),p.edge(e.id,z).weight+=1,null==u[e.id][l][z]&&(u[e.id][l][z]=0),u[e.id][l][z]+=1)}0<g&&p.addEdge(e.id,t.id,{weight:0})});if(null!=t){n=[];p.getTotalWeightGrowthSequence(this,function(a){return a.weight},function(a){n.push(a)});0===n.length&&(n=[t.id]);var r=
n,w=[],x,R,V,S,ia,T,aa,X,la,U,ba,P,M,Y,ma,Q,ca,ea,fa,da;R=new primitives.famdiagram.Slots;R.add(new primitives.famdiagram.Slot("__left__"));R.add(new primitives.famdiagram.Slot(null));R.add(new primitives.famdiagram.Slot("__right__"));V=0;R.loop(function(a){V+=1;a.position=V});for(x=0;x<r.length;x+=1)if(S=r[x],"__left__"!=S&&"__right__"!=S)for(ca in la=X=aa=T=ia=null,R.loop(function(a){var b,d,f,e;if(null==a.itemId){Y=c[S];M=P=ba=U=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(Y&&null!=Y[b]&&
(U+=a.crossings[b]*Y[b]),M+=a.crossings[b]);for(b in u[S])if(u[S].hasOwnProperty(b))for(d in f=u[S][b],f)f.hasOwnProperty(d)&&(e=R.getSlot(d),null!=e&&(e.position<a.position?(U+=(a.left[b]||0)-(e.left[b]||0),P+=Math.abs(e.balance+1)):(U+=(a.right[b]||0)-(e.right[b]||0),P+=Math.abs(e.balance-1)),ba+=Math.abs(e.position-a.position)));if(null==T||T>U||T==U&&(aa>ba||aa==ba&&(X>P||X==P&&la>M)))T=U,ia=a,aa=ba,X=P,la=M}}),ma=ia.clone(),Q=ia.clone(),Q.itemId=S,R.insertBefore(ia,ma),R.insertBefore(ia,Q),V=
Q.position=0,R.loop(function(a){var b,d;if(a.id!=Q.id){d=c[S];for(b in d)d.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+d[b]:d[b]);V+=1;a.position=V}},Q),V=0,R.backwardLoop(function(a){var b,d;if(a.id!=Q.id){d=c[S];for(b in c[S])c[S].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+d[b]:d[b]);V-=1;a.position=V}},Q),u[S])if(u[S].hasOwnProperty(ca))for(fa in ea=u[S][ca],ea)ea.hasOwnProperty(fa)&&(da=R.getSlot(fa),null!=da&&(0>da.position?(da.balance+=1,Q.balance-=1,R.backwardLoop(function(a){if(a.id!=
Q.id)if(a.id!=da.id)a.crossings[ca]=a.crossings[ca]?a.crossings[ca]+ea[fa]:ea[fa];else return!0},Q)):(da.balance-=1,Q.balance+=1,R.loop(function(a){if(a.id!=Q.id)if(a.id!=da.id)a.crossings[ca]=a.crossings[ca]?a.crossings[ca]+ea[fa]:ea[fa];else return!0},Q))));R.loop(function(a){a=a.itemId;null!=a&&("__left__"!=a&&"__right__"!=a)&&w.push(a)});i=w;e=0;for(g=i.length;e<g;e+=1)k=a.node(i[e]),k.childIndex=e,l.push(k.id)}a.arrangeChildren(q.id,l)})}function l(a,b,c){var d=new primitives.famdiagram.ExtraGravity(b.level),
f=new primitives.famdiagram.ExtraGravity(c.level);p.zipUp(this,b.id,c.id,function(b,c,e,g){m(a,b,d);m(a,e,f);if(c==g)return d.commonParent=c,d.fromParent=b,d.toParent=e,f.commonParent=c,f.fromParent=e,f.toParent=b,!0})}function m(a,b,c){a.hasOwnProperty(b)||(a[b]={});null==a[b][c.level]&&(a[b][c.level]=[]);a[b][c.level].push(c)}function n(a,b,c,d){var f=[],e=null,g=null,j;1==b.countChildren(a.id)&&(e=b.firstChild(a.id));null!=w[e]?(g=w[e],null==r[g.id]&&(r[g.id]=[]),r[g.id].push(a.id),d.links.push(new primitives.famdiagram.FamLink(a.id,
e))):(null!=e&&(w[e]=a),b.loopChildren(this,a.id,function(e,g){if(c[g.id])throw"Many to many relations should not exist at this stage";f.push(g);j=s(g.id,a.id,d.id,g.level,g.itemConfig);j.hideParentConnection=g.hideParentConnection;j.hideChildrenConnection=g.hideChildrenConnection;j.isVisible=g.isVisible;j.isActive=g.isActive;d.items.push(j);c[g.id]=!0;g.familyId=d.id;return b.SKIP}));return f}function s(a,c,d,f,e){var g=new primitives.orgdiagram.OrgItem({});g.id=a;g.familyId=d;g.level=f;a=0;for(d=
u.length;a<d;a+=1)f=u[a],g[f]=null!=e&&void 0!==e[f]?e[f]:b[f];p.add(c,g.id,g);return g}function q(a,b,c,d,f){var e,g,j,h,l,i,k,m,n,s={},q,p,u;c.loopLevels(this,function(t){var z=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[t]=z;n=[];c.loopLevelItems(this,t,function(b,c){var j=[],h=[],l;if(!s.hasOwnProperty(b)){s[b]=!0;c.hideChildrenConnection||j.push(b);l=f[b];if(null!=l){e=0;for(g=l.length;e<g;e+=1){var i=l[e];s[i]=!0;j.push(i)}}d.loopChildren(this,b,function(a,b){b.hideParentConnection||
h.push(a)});if(1<j.length||0<h.length)m=new primitives.orgdiagram.ConnectorBundle,m.fromLevel=t,m.fromItems=j,m.toItems=h,a.push(m),1<j.length&&n.push(m)}});if(0<n.length){u=primitives.common.pile();j=0;for(h=n.length;j<h;j+=1){m=n[j];p=q=null;l=0;for(i=m.fromItems.length;l<i;l+=1)k=c.getItemPosition(m.fromItems[l]),q=null!=q?Math.min(q,k):k,p=null!=p?Math.max(p,k):k;u.add(q,p,m)}z.parentsStackSize=u.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}h=g=f=e=d=null;var p,r,w={},x,t,u="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" "),
z=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var b=a.getLogicalFamily(),b=b.clone();p=primitives.common.tree();d=a.getMaximumId();r={};w={};t=x=null;i(b);e=primitives.common.TreeLevels();f=primitives.common.TreeLevels();p.loopLevels(this,function(a,b,d){var g=c.getTemplateParams(a);e.addItem(d,a,b);null!=g&&(g.isActive&&b.isVisible)&&f.addItem(d,a,b)});g=[];h=[];q(g,h,e,p,r);return!0},getMaximumId:function(){return d},getTreeLevels:function(){return e},getActiveTreeLevels:function(){return f},
getBundles:function(){return g},getConnectorsStacksSizes:function(a){return h[a]||z}}};
primitives.famdiagram.LogicalFamilyTask=function(a){var b=null,c=null;return{process:function(d){var e,f,g,h,i=a.getItems(),k=primitives.common.family(),j=0;if(0<i.length){e=0;for(f=i.length;e<f;e+=1)g=i[e],null!=g&&(h=new primitives.famdiagram.FamilyItem({id:g.id,itemConfig:g,isActive:g.isActive}),k.add(g.parents,h.id,h),g=parseInt(g.id,10),j=Math.max(isNaN(g)?0:g,j))}b=k;c=j;if(d&&!k.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return b},getMaximumId:function(){return c}}};
primitives.famdiagram.NormalizeLogicalFamilyTask=function(a,b){function c(a,b,c){if(0<a.hasNodes()){a.loopLevels(this,1==k.groupByType,function(a,b,c){b.level=c});a.optimizeReferences(function(){b+=1;return new primitives.famdiagram.FamilyItem({id:b,isVisible:!1,isActive:!1,itemConfig:{title:"bundle #"+b,description:" This item was created by references optimizer."},levelGravity:2})});if(c&&!a.validate())throw"References are broken in family structure!";if(c&&a.hasLoops())throw"Structure has loops!";
a.eliminateManyToMany(function(){b+=1;return new primitives.famdiagram.FamilyItem({id:b,isVisible:!1,isActive:!1,itemConfig:{title:"dummy #"+b,description:"This is item used to eliminate M:M relations."},levelGravity:2,hideParentConnection:!1,hideChildrenConnection:!1})});if(c&&!a.validate())throw"References are broken in family structure!";k.alignBylevels?d(a):a.loopLevels(this,1==k.groupByType,function(a,b,c){b.level=c});c&&g(a,!1);f(a,function(){b+=1;return new primitives.famdiagram.FamilyItem({id:b,
...
a.loop(this,function(c,d){a.loopChildren(this,c,function(c,f){if(null===f.level||null===d.level||(b?f.level!=d.level+1:f.level<=d.level))throw"Family tree is broken. Children/Parents or levels mismatch!";return a.SKIP})})}var h=null,i=null,k;return{process:function(d){var f=b.getLogicalFamily(),e=b.getMaximumId();k=a.getOptions();f=!0==k.hideGrandParentsConnectors?f.getFamilyWithoutGrandParentsRelations():f.clone();e=c(f,e,d);h=f;i=e;if(d&&!f.validate())throw"References are broken in family structure!";
return!0},getLogicalFamily:function(){return h},getMaximumId:function(){return i}}};
primitives.famdiagram.RemoveLoopsTask=function(a,b){function c(a,b,c){var d,e,j,l,m,n,s,q,p;d=b.clone();b.loopTopo(this,function(a){d.removeNode(a)});if(d.hasNodes()){l=0;for(m=a.length;l<m;l+=1)if(e=a[l],null!=d.node(e.id)){p=[];d.loopParents(this,e.id,function(a){p.push(a);return d.SKIP});n=0;for(s=p.length;n<s;n+=1)d.removeRelation(p[n],e.id),b.removeRelation(p[n],e.id);c+=1;j=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,
itemConfig:{title:"fake parent #"+c,description:"This is fake parent item was created by loops reversal."}});b.add([],j.id,j);b.adopt([j.id],e.id);n=0;for(s=p.length;n<s;n+=1)c+=1,e=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+c,description:"This is fake child item was created by loops reversal."}}),b.add([j.id,p[n]],e.id,e);q=[];d.loopTopo(this,function(a){q.push(a)});n=0;for(s=
q.length;n<s;n+=1)d.removeNode(q[n])}}return c}var d=null,e=null;return{process:function(f){var g=b.getNavigationFamily(),h=b.getMaximumId(),i=a.getItems(),g=g.clone(),h=c(i,g,h,f);d=g;e=h;if(f&&!g.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return e}}};
...
["layout","OptionsTask"],primitives.orgdiagram.CurrentScrollPositionTask,"#000000");f.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],primitives.orgdiagram.CalloutOptionTask,"#ffffff");f.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ConnectorsOptionTask,"#ffffff");f.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],primitives.famdiagram.ItemsOptionTask,"#ffffff");f.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],
primitives.famdiagram.SpousesOptionTask,"#ffffff");f.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],primitives.orgdiagram.ItemsSizesOptionTask,"#ffffff");f.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],primitives.orgdiagram.LabelsOptionTask,"#ffffff");f.addTask("PrintPreviewOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.PrintPreviewOptionTask,"#ffffff");f.addTask("TemplatesOptionTask",["OptionsTask",
"defaultConfig","defaultButtonConfig","defaultTemplateConfig"],primitives.orgdiagram.TemplatesOptionTask,"#ffffff");f.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.OrientationOptionTask,"#ffffff");f.addTask("VisualTreeOptionTask",["OptionsTask"],primitives.famdiagram.VisualTreeOptionTask,"#ffffff");f.addTask("MinimizedItemsOptionTask",["OptionsTask"],primitives.orgdiagram.MinimizedItemsOptionTask,"#ffffff");f.addTask("NormalizeOptionTask",["OptionsTask","defaultConfig"],
primitives.famdiagram.NormalizeOptionTask,"#ffffff");f.addTask("LinePaletteOptionTask",["OptionsTask","defaultPaletteItemConfig"],primitives.famdiagram.LinePaletteOptionTask,"#ffffff");f.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorItemOptionTask,"#ffffff");f.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.HighlightItemOptionTask,"#ffffff");f.addTask("SelectedItemsOptionTask",["OptionsTask"],primitives.orgdiagram.SelectedItemsOptionTask,
"#ffffff");f.addTask("CursorSelectionPathModeOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorSelectionPathModeOptionTask,"#ffffff");f.addTask("NeighboursSelectionModeOptionTask",["OptionsTask","defaultConfig"],primitives.famdiagram.NeighboursSelectionModeOptionTask,"#ffffff");f.addTask("SplitAnnotationsOptionTask",["OptionsTask"],primitives.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");f.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig",
"foreground"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");f.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");f.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");f.addTask("BackgroundHighlightPathAnnotationOptionTask",
["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");f.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");f.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,
"#ffffff");f.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#ffffff");f.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#ffffff");f.addTask("IntervalsTask",["ItemsSizesOptionTask"],primitives.orgdiagram.IntervalsTask,"#00ffff");f.addTask("LogicalFamilyTask",["ItemsOptionTask"],primitives.famdiagram.LogicalFamilyTask,"#00ffff");f.addTask("LabelAnnotationOptionTask",
["SplitAnnotationsOptionTask","LogicalFamilyTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationOptionTask,"#ffffff");f.addTask("LabelAnnotationTemplateOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationTemplateOptionTask,"#ffffff");f.addTask("LabelAnnotationPlacementOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationPlacementOptionTask,"#ffffff");f.addTask("CombinedContextsTask",
...
primitives.orgdiagram.DrawItemLabelsTask,"#008000");f.addTask("DrawPrintPreviewTask","graphics ApplyLayoutChangesTask PrintPreviewOptionTask AlignDiagramTask PrintPreviewTemplateTask ScaleOptionTask".split(" "),primitives.orgdiagram.DrawPrintPreviewTask,"#008000");return f},function(a,b,e,f){var g=new primitives.famdiagram.EventArgs,h=a.tasks.getTask("CombinedContextsTask"),i=a.tasks.getTask("AlignDiagramTask"),k=a.tasks.getTask("LogicalFamilyTask"),b=h.getConfig(b),j=h.getConfig(e),l=k.getLogicalFamily();
b&&null!=b.id&&(g.oldContext=b);j&&null!=j.id&&(g.context=j,l.loopParents(this,j.id,function(a,b,c){if(0<c)return l.BREAK;g.parentItems.push(h.getConfig(a))}),l.loopChildren(this,j.id,function(a,b,c){if(0<c)return l.BREAK;g.childrenItems.push(h.getConfig(a))}),k=a.layout.mousePanel.offset(),a=a.layout.element.offset(),e=i.getItemPosition(e),g.position=(new primitives.common.Rect(e.actualPosition)).translate(k.left,k.top).translate(-a.left,-a.top));null!=f&&(g.name=f);return g})};
...
this.onHighlightChanging=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#ffffff";this.minimizedItemShapeType=6;this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.highlightLinesColor="#ff0000";this.highlightLinesWidth=1;this.highlightLinesType=0;this.calloutMaximumVisibility=2;this.showCallout=
...
primitives.orgdiagram.AlignDiagramTask=function(a,b,c,d,e,f,g,h,i){function k(a,b){var c=new primitives.common.Size(x.printPreviewPageSize),d,f,e;c.scale(1/u.scale);switch(w.orientationType){case 2:case 3:c.invert()}d=0;f=c.width;n.loopMerged(this,function(a){return q[a].actualPosition.x},function(b){var e=new primitives.orgdiagram.TreeItemPosition(q[b]);a[b]=e;e.actualPosition.left()+d<f&&e.actualPosition.right()+d>f&&(d+=f-e.actualPosition.left()-d+r.normalItemsInterval/2);e.actualPosition.translate(d,
0);e.actualPosition.left()>f&&(f+=c.width)});d=0;e=c.height;n.loopLevels(this,function(f){var g=new primitives.orgdiagram.TreeLevelPosition(p[f]);g.shift+d<e&&g.shift+g.depth+d>e&&(d+=e-g.shift-d+r.normalLevelShift/2);g.shiftDown(d);n.loopLevelItems(this,f,function(b){a[b].actualPosition.translate(0,d)});g.shift>e&&(e+=c.height);b.push(g)});return new primitives.common.Size(f+1,e+1)}var j={},l=[],m=null,n,s,q,p,r,w,x,t,u;return{process:function(){var z=new primitives.common.Size(h.getContentSize()),
v=new primitives.common.Size(f.getOptimalPanelSize());n=g.getTreeLevels();s=g.getActiveTreeLevels();q=h.getItemsPositions();p=h.getTreeLevelsPositions();r=b.getOptions();w=a.getOptions();x=e.getOptions();t=c.getOptions();u=d.getOptions();switch(w.orientationType){case 2:case 3:v.invert()}v.scale(1/u.scale);m=v;j=q;l=p;switch(r.pageFitMode){case 4:j={};l=[];m=k(j,l);break;case 5:m=new primitives.common.Size(z);break;default:m=new primitives.common.Size(z);if(z.width<v.width){j={};var y=z.width,A=v.width,
B;if(i)B=(A-y)/2;else switch(t.horizontalAlignment){case 1:B=0;break;case 2:B=A-y;break;case 0:B=(A-y)/2}var y=j,C;for(C in q)q.hasOwnProperty(C)&&(A=new primitives.orgdiagram.TreeItemPosition(q[C]),A.actualPosition.translate(B,0),y[C]=A);m.width=v.width}z.height<v.height&&(m.height=v.height)}switch(w.orientationType){case 2:case 3:m.invert()}return!0},getTreeLevelsPositions:function(){return l},getItemPosition:function(a){return j[a]},getItemsPositions:function(){return j},getContentSize:function(){return m},
getTreeItemForMousePosition:function(a,b,c){var d=null,f=null,e=null,g,h=u.scale,a=a/h,b=b/h;s.loopLevels(this,function(a){var c=l[a];if(b>c.shift+c.topConnectorShift&&b<=c.shift+c.connectorShift)return f=a,!0;g=Math.min(Math.abs(b-(c.shift+c.topConnectorShift)),Math.abs(b-(c.shift+c.connectorShift)));if(null==e||e>g)e=g,f=a});null!=f&&(d=s.binarySearch(this,f,function(c){c=j[c];switch(c.actualVisibility){case 1:if(c.actualPosition.contains(a,b))return 0;case 2:case 3:return a-c.actualPosition.horizontalCenter();
case 4:throw"Clickable items collection should contain only visible items.";}}));if(null!=d)switch(h=j[d],h.actualVisibility){case 1:break;default:if(Math.abs(a-h.actualPosition.horizontalCenter())>Math.max(c,h.actualPosition.width/2)||Math.abs(b-h.actualPosition.verticalCenter())>Math.max(c,h.actualPosition.height/2))d=null}return d},getNextLevelTreeItem:function(a,b){var c=j[a].actualPosition.horizontalCenter(),d=a,f=null,e;s.loopLevelsFromItem(this,a,b,function(a){s.loopLevelItems(this,a,function(a){var b=
j[a];if(1==b.actualVisibility)if(e=Math.abs(c-b.actualPosition.horizontalCenter()),e<f||null==f)f=e,d=a;else return!0});if(null!=f)return!0});return d},getNextTreeItem:function(a,b){var c=a.id,d;s.loopFromItem(this,a,b,function(a){d=q[a];if(1==d.actualVisibility)return c=a,!0});return c}}};
primitives.orgdiagram.ApplyLayoutChangesTask=function(a,b,c,d,e,f,g){var h=null,i,k;return{process:function(){var j=b(),l=a(),m=f.getOptions().scale;i=d.getOptions();k=c.getOptions();var n=new primitives.common.Size(g.getContentSize());n.scale(1*m);j.mousePanel.css(n.getCSS());var s=new primitives.common.Size(g.getContentSize());j.placeholder.css(s.getCSS());l.resize("placeholder",s.width,s.height);switch(i.pageFitMode){case 5:h=new primitives.common.Size(n.width+25,n.height+25);h.cropBySize(k.autoSizeMaximum);
h.addSize(k.autoSizeMinimum);j.element.css({width:h.width+"px",height:h.height+"px"});break;case 4:h=new primitives.common.Size(n.width+25,n.height+25);j.element.css({width:h.width+"px",height:h.height+"px"});break;default:h=new primitives.common.Size(e.getScrollPanelSize())}l=j.element.offset();j.scrollPanel.css({top:"0px",left:"0px",width:h.width+"px",height:h.height+"px","margin-bottom":"0px","margin-right":"0px","margin-top":-l.top+Math.floor(l.top)+"px","margin-left":-l.left+Math.floor(l.left)+
"px"});m="scale("+m+","+m+")";j.placeholder.css({"transform-origin":"0 0",transform:m,"-ms-transform":m,"-webkit-transform":m,"-o-transform":m,"-moz-transform":m});return!0},getOptimalPanelSize:function(){return new primitives.common.Size(h.width-25,h.height-25)}}};
primitives.orgdiagram.CenterOnCursorTask=function(a,b,c,d,e,f,g){function h(a){var b=!1;k.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,c,d,f){b=new primitives.common.Rect(a,c,d,f)});return b}var i=null,k;return{process:function(){var j;j=a();var l=d.getCursorTreeItem(),m=e.getItemPosition(l),l=e.getContentSize(),n;n=g.getOptions().scale;i=c.getPlaceholderOffset();j.forceCenterOnCursor&&(k=f.getTransform(),null!=m&&(j=h(m.actualPosition),j.scale(n),l.scale(n),n=b.getScrollPanelSize(),
i=new primitives.common.Point(Math.max(Math.min(j.horizontalCenter()-n.width/2,l.width-n.width),0),Math.max(Math.min(j.verticalCenter()-n.height/2,l.height-n.height),0))));return!0},getPlaceholderOffset:function(){return i}}};
...
primitives.orgdiagram.DrawBackgroundAnnotationTask=function(a,b,c,d,e,f,g){function h(a,b,c){var d,e,g,h,r,w,x,t,u,z,v;d=0;for(e=a.length;d<e;d+=1)if(v=a[d],null!=v.items&&0<v.items.length){r=new primitives.common.Perimeter(i);r.transform=k;w=new primitives.orgdiagram.BackgroundAnnotationConfig;u=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=u.length;g<h;g+=1)z=u[g],r[z]=v.hasOwnProperty(z)?v[z]:w[z];i.activate("placeholder",2);x=[];t={};if(v.includeChildren){g=0;for(h=v.items.length;g<
h;g+=1)w=v.items[g],u=f.getItemPosition(w),null!=u&&(t[w]=!0,x.push(w),c.loopChildren(this,w,function(a){t[a]||(t[a]=!0,x.push(a))}))}else x=v.items;v=b.getMergedPerimeters(x);for(g=0;g<v.length;g+=1)r.draw(v[g])}}var i,k;return{process:function(){var c=d.getAnnotations(),f,m;i=a();i.reset("placeholder",2);0<c.length&&(k=b.getTransform(),f=g.getBackgroundManager(),m=e.getNavigationFamily(),h(c,f,m));return!1}}};
primitives.orgdiagram.DrawConnectorAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,u,z,v=new primitives.common.PolylinesBuffer,y=primitives.orgdiagram.ConnectorAnnotationOffsetResolver(),A=0;switch(h){case 1:k.activate("placeholder",4);break;case 2:k.activate("placeholder",14)}c=0;for(d=a.length;c<d;c+=1)u=a[c],A=Math.max(A,u.lineWidth);c=0;for(d=a.length;c<d;c+=1)if(u=a[c],null!=u.fromItem&&null!=u.toItem&&(f=b(u.fromItem),e=b(u.toItem),null!=f&&null!=e)){f=f.actualPosition;
g=e.actualPosition;switch(u.connectorPlacementType){case 0:i=new primitives.common.ConnectorOffbeat;break;case 1:i=new primitives.common.ConnectorStraight}var B;j.transformRect(0,0,u.labelSize.width,u.labelSize.height,!1,this,function(a,b,c,d){B=new primitives.common.Size(c,d)});var C=null;j.transformRect(0,0,m.width,m.height,!1,this,function(a,b,c,d){C=new primitives.common.Size(c,d)});e=new primitives.common.PaletteItem({lineColor:u.color,lineWidth:u.lineWidth,lineType:u.lineType});var D=!primitives.common.isNullOrEmpty(u.label);
f=(new primitives.common.Rect(f)).offset(u.offset);g=(new primitives.common.Rect(g)).offset(u.offset);i.draw(v,e,f,g,3*u.lineWidth,6*A,B,C,u.connectorShapeType,4,u.labelPlacementType,D,y,function(a){D&&null!=a&&(j.transformRect(a.x,a.y,a.width,a.height,!0,this,function(b,c,d,f){a=new primitives.common.Rect(b,c,d,f)}),z=new primitives.common.RenderEventArgs,z.context=u,k.template(a.x,a.y,0,0,0,0,a.width,a.height,l.template(),l.getHashCode(),l.render,z,null))})}y.resolve();v.transform(j,!0);k.polylinesBuffer(v)}
var k,j,l,m;return{process:function(){k=a();j=b.getTransform();d.getOptions();l=g.getTemplate();m=new primitives.common.Size(f.getContentSize());switch(h){case 1:k.reset("placeholder",4);break;case 2:k.reset("placeholder",14)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawConnectorsTask=function(a,b,c,d,e){return{process:function(){var f=a(),g=b.getGraph(),h=c.getOptions(),i=e.getPaletteManager();f.reset("placeholder",6);f.activate("placeholder",6);var k=new primitives.common.PolylinesBuffer,j=Math.round(h.elbowDotSize/2),l={},m={};g.loopNodes(this,null,function(a){g.loopNodeEdges(this,a,function(b,c){if(!l.hasOwnProperty(b)){var f=null;1>=c.fromOffset?f=i.getPalette(1):(i.selectPalette(c.fromOffset),f=i.getPalette(0));var e=k.getPolyline(f);
if(d&&null!=c.dotId&&0!=h.elbowType&&!m.hasOwnProperty(c.dotId)){var f=k.getPolyline(e.arrowPaletteItem),g=c.dotId==c.from?c.polyline.getStartPoint():c.polyline.getEndPoint();f.addSegment(new primitives.common.DotSegment(g.x-j,g.y-j,2*j,2*j,j));m[c.dotId]=!0}f=null;null!=c.parentsArrowId&&1==h.arrowsDirection?f=c.parentsArrowId:null!=c.childrenArrowId&&2==h.arrowsDirection&&(f=c.childrenArrowId);null==f?(f=c.polyline.clone(),c.hasMiddle&&0!=h.arrowsDirection&&(g=!0,g=c.from==c.middleParent?2==h.arrowsDirection:
1==h.arrowsDirection,f.addOffsetArrow(g,h.linesWidth,0.4,h.extraArrowsMinimumSpace,function(a){a.mergeTo(k.getPolyline(e.arrowPaletteItem))})),c.from==a?f.mergeTo(e):e.addInverted(f)):(f==c.to?c.polyline.clone().mergeTo(e):e.addInverted(c.polyline.clone()),e.addArrow(h.linesWidth,function(a){a.mergeTo(k.getPolyline(a.paletteItem))}))}});l[a]=!0});f.polylinesBuffer(k);return!1}}};
primitives.orgdiagram.DrawCursorTask=function(a,b,c,d,e,f,g,h){function i(a){var b;k.activate("placeholder",11);var c=e.getItemPosition(a),g=c.actualPosition,i=new primitives.common.Rect(c.contentPosition),p=f.getTemplateParams(a).template,r=p.templateConfig,c=r.cursorPadding;i.offset(c.left,c.top,c.right,c.bottom);b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=!0;b.isSelected=h.isSelected(a);b.templateName=r.name;j.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,
c,d,f){k.template(a,c,d,f,i.x,i.y,i.width,i.height,p.cursorTemplate.template(),p.cursorTemplate.getHashCode(),p.cursorTemplate.render,b,{"border-width":r.cursorBorderWidth})})}var k,j;return{process:function(){var c=g.getCursorTreeItem();k=a();k.reset("placeholder",11);null!=c&&(j=b.getTransform(),i(c));return!1}}};
primitives.orgdiagram.DrawHighlightAnnotationTask=function(a,b,c,d,e,f,g,h,i,k,j,l,m){function n(a){var b,c,j,n,y,A,B=!0,C,D=i.getItemPosition(a),E=D.actualPosition;switch(D.actualVisibility){case 2:case 3:case 1:b=g.getItemOptions(a);switch(b.showCallout){case 2:B=!1;break;case 1:B=!1;break;default:B=r.showCallout}B?(s.activate("placeholder",12),q.transformRect(E.x,E.y,E.width,E.height,!0,this,function(g,q,E,F){var q=new primitives.common.Rect(g,q,E,F),g=new primitives.common.Point(q.horizontalCenter(),
q.verticalCenter()),E=e.getOptions().scale,F=new primitives.common.Point(k.getPlaceholderOffset()),B=i.getContentSize(),K=d.getOptimalPanelSize();F.scale(1/E);K.scale(1/E);E=new primitives.common.Rect(F.x,F.y,Math.min(K.width,B.width),Math.min(K.height,B.height));if(D.actualVisibility>=r.calloutMaximumVisibility&&4!=D.actualVisibility||!E.overlaps(q)){y=!primitives.common.isNullOrEmpty(b.calloutTemplateName)?b.calloutTemplateName:!primitives.common.isNullOrEmpty(b.templateName)?b.templateName:!primitives.common.isNullOrEmpty(r.defaultCalloutTemplateName)?
r.defaultCalloutTemplateName:r.defaultTemplateName;A=h.getTemplate(y,h.DefaultWidgetTemplateName);q=A.templateConfig.itemSize;F=new primitives.common.Rect(g.x,g.y,q.width,q.height);switch(r.orientationType){case 0:case 1:F.y-=q.height/4;F.x=g.x<E.horizontalCenter()?F.x+r.calloutPlacementOffset:F.x-(r.calloutPlacementOffset+q.width);break;default:F.x-=q.width/4,F.y=g.y<E.verticalCenter()?F.y+r.calloutPlacementOffset:F.y-(r.calloutPlacementOffset+q.height)}F.x<E.x?F.x=E.x+5:F.right()>E.right()&&(F.x-=
F.right()-E.right()+5);F.y<E.y?F.y=E.y+5:F.bottom()>E.bottom()&&(F.y-=F.bottom()-E.bottom()+5);j=F;c=new primitives.common.Rect(j);c.addRect(g.x,g.y);c.offset(50);C=c.getCSS();C.display="inherit";C.visibility="inherit";w.calloutPlaceholder.css(C);g.x-=c.x;g.y-=c.y;j.x-=c.x;j.y-=c.y;n=new primitives.common.RenderEventArgs;n.context=f.getConfig(a);n.isCursor=l.getCursorTreeItem()==a;n.isSelected=m.isSelected(a);n.templateName=A.templateConfig.name;s.resize("calloutplaceholder",c.width,c.height);s.activate("calloutplaceholder",
15);s.template(j.x,j.y,j.width,j.height,0,0,j.width,j.height,A.itemTemplate.template(),A.itemTemplate.getHashCode(),A.itemTemplate.render,n,null);p.pointerPlacement=0;p.cornerRadius=r.calloutCornerRadius;p.offset=r.calloutOffset;p.opacity=r.calloutOpacity;p.lineWidth=r.calloutLineWidth;p.pointerWidth=r.calloutPointerWidth;p.borderColor=r.calloutBorderColor;p.fillColor=r.calloutfillColor;p.draw(g,j)}else w.calloutPlaceholder.css({display:"none",visibility:"hidden"})})):w.calloutPlaceholder.css({display:"none",
visibility:"hidden"});break;case 4:w.calloutPlaceholder.css({display:"none",visibility:"hidden"})}}var s,q,p=new primitives.common.Callout(b()),r,w;return{process:function(){var d=j.getHighlightTreeItem();s=b();s.reset("calloutplaceholder",15);null!==d&&(q=c.getTransform(),r=g.getOptions(),w=a(),n(d));return!1}}};
primitives.orgdiagram.DrawHighlightPathAnnotationTask=function(a,b,c,d,e){function f(a,b,c,d){var f,l,m,n,s,q,p,r,w,x,t,u,z;if(0<c.length){t=new primitives.common.PolylinesBuffer;switch(e){case 1:a.activate("placeholder",5);break;case 2:a.activate("placeholder",7)}var v={};f=0;for(l=c.length;f<l;f+=1)if(x=c[f],null!=x.items&&0<x.items.length&&(r=x.items.slice(0),s=r[0],d.hasNode(s))){m=1;for(n=r.length;m<n;m+=1)q=r[m],d.hasNode(q)&&(v.hasOwnProperty(s)?v[s].push(q):v[s]=[q],s=q)}var y={};for(u in v)y[u]=
{},v.hasOwnProperty(u)&&d.getShortestPath(this,u,v[u],function(a){return a.weight},function(a,b){y[u][b]=a});f=0;for(l=c.length;f<l;f+=1)if(x=c[f],m=new primitives.common.PaletteItem({lineColor:null!=x.color?x.color:b.highlightLinesColor,lineWidth:null!=x.lineWidth?x.lineWidth:b.highlightLinesWidth,lineType:null!=x.lineType?x.lineType:b.highlightLinesType,fillColor:null,opacity:x.opacity}),v=t.getPolyline(m),null!=x.items&&0<x.items.length&&(r=x.items.slice(0),s=r[0],d.hasNode(s))){m=1;for(n=r.length;m<
n;m+=1)if(q=r[m],d.hasNode(q)){p=y[s][q]||[];for(s=p.length-2;0<=s;s-=1)u=p[s+1],z=p[s],w=d.edge(u,z),w.from==u?w.polyline.clone().mergeTo(v):v.addInverted(w.polyline.clone()),x.showArrows&&(z==w.parentsArrowId||z==w.childrenArrowId)&&v.addArrow(x.lineWidth,function(a){a.mergeTo(t.getPolyline(a.paletteItem))});s=q}}a.polylinesBuffer(t)}}return{process:function(){var g=d.getGraph(),h=b.getOptions(),i=c.getAnnotations(),k=a();switch(e){case 1:k.reset("placeholder",5);break;case 2:k.reset("placeholder",
7)}f(k,h,i,g);return!1}}};
primitives.orgdiagram.DrawHighlightTask=function(a,b,c,d,e,f,g,h,i){function k(a){var b;j.activate("placeholder",8);var c=e.getItemPosition(a),g=c.actualPosition,k=f.getTemplateParams(a).template,r=k.templateConfig,w=r.highlightPadding;b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=h.getCursorTreeItem()==a;b.isSelected=i.isSelected(a);b.templateName=r.name;l.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,d,f,e){var g=new primitives.common.Rect(0,0,Math.round(f),
Math.round(e));g.offset(w.left,w.top,w.right,w.bottom);1==c.actualVisibility?j.template(a,d,f,e,g.x,g.y,g.width,g.height,k.highlightTemplate.template(),k.highlightTemplate.getHashCode(),k.highlightTemplate.render,b,null):j.template(a,d,f,e,g.x,g.y,g.width-1,g.height-1,k.dotHighlightTemplate.template(),k.dotHighlightTemplate.getHashCode(),k.dotHighlightTemplate.render,b,null)})}var j,l;return{process:function(){var c=g.getHighlightTreeItem();j=a();j.reset("placeholder",8);null!=c&&(l=b.getTransform(),
k(c));return!1}}};
primitives.orgdiagram.DrawItemLabelsTask=function(a,b,c,d,e,f){function g(){var a,b,c,e,g,p,r,w=[];k.loopLevels(this,function(a){var c=[];k.loopLevelItems(this,a,function(a){var e=d.getItemOptions(a),g=f.getItemPosition(a),a=g.actualPosition;null!=e&&i.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,d,f,h){switch(g.actualVisibility){case 1:0==j.showLabels&&(b=new primitives.common.Label,b.text="dummy",b.position=new primitives.common.Rect(a,d,f,h),b.weight=1E4,b.labelType=1,c.push(b));break;
case 2:var i,k,l=null,n=j.labelOffset,s,p;if(!primitives.common.isNullOrEmpty(e.label)){switch(e.showLabel){case 0:switch(j.showLabels){case 0:switch(g.actualVisibility){case 3:case 2:l=new primitives.common.Label,l.labelType=0,l.weight=g.leftPadding+g.rightPadding}break;case 1:l=new primitives.common.Label,l.labelType=2,l.weight=1E4}break;case 1:l=new primitives.common.Label,l.weight=1E4,l.labelType=2}if(null!=l){l.text=e.label;s=null!=e.labelSize?e.labelSize:j.labelSize;l.labelOrientation=3!=e.labelOrientation?
e.labelOrientation:3!=j.labelOrientation?j.labelOrientation:0;p=0!=e.labelPlacement?e.labelPlacement:0!=j.labelPlacement?j.labelPlacement:1;switch(l.labelOrientation){case 0:i=s.width;k=s.height;break;case 1:case 2:k=s.width,i=s.height}switch(p){case 0:case 1:l.position=new primitives.common.Rect(a+f/2-i/2,d-n-k,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=
2,l.verticalAlignmentType=1}break;case 2:case 11:l.position=new primitives.common.Rect(a+f+n,d-n-k,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=2,l.verticalAlignmentType=2}break;case 3:l.position=new primitives.common.Rect(a+f+n,d+h/2-k/2,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=2}break;case 4:case 12:l.position=new primitives.common.Rect(a+f+n,d+h+n,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=2}break;case 5:l.position=new primitives.common.Rect(a+f/2-i/2,d+h+n,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=1}break;case 6:case 10:l.position=new primitives.common.Rect(a-i-n,d+h+n,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=0}break;case 7:l.position=new primitives.common.Rect(a-
i-n,d+h/2-k/2,i,k);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=0}break;case 8:case 9:switch(l.position=new primitives.common.Rect(a-i-n,d-n-k,i,k),l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=
2,l.verticalAlignmentType=0}}}}b=l;null!=b&&c.push(b)}})});w[a]=c});var x=[],t=[],u=[];0==j.showLabels&&(k.loopLevels(this,function(a){var b=w[a],c,d,f=!1;e=0;for(p=b.length;e<p;e+=1)c=b[e],null==d?d=new primitives.common.Rect(c.position):d.addRect(c.position),f=f||2==c.labelType;x[a]=d;t[a]=f}),k.loopLevelsReversed(this,function(a){var b=x[a-1],c=x[a];u[a]=!0;null!=b&&null!=c&&b.overlaps(c)&&(u[a]=!1)}),k.loopLevels(this,function(d){a=w[d];if(u[d]){e=0;for(p=a.length;e<p;e+=1)if(b=a[e],b.isActive)for(g=
e+1;g<p;g+=1)if(c=a[g],c.isActive)if(b.position.overlaps(c.position))if(b.weight>=c.weight)0==c.labelType&&(c.isActive=!1);else{0==b.labelType&&(b.isActive=!1);break}else break}}));h.activate("placeholder",10);r={"font-size":j.labelFontSize,"font-family":j.labelFontFamily,"font-style":j.labelFontStyle,"font-weight":j.labelFontWeight,"font-color":j.labelColor};k.loopLevels(this,function(a){if(1==j.showLabels||u[a]||t[a]){a=w[a];e=0;for(p=a.length;e<p;e+=1)if(b=a[e],b.isActive)switch(b.labelType){case 0:case 2:h.text(b.position.x,
b.position.y,b.position.width,b.position.height,b.text,b.labelOrientation,b.horizontalAlignmentType,b.verticalAlignmentType,r)}}})}var h,i,k,j;return{process:function(){h=a();i=b.getTransform();j=d.getOptions();k=e.getTreeLevels();h.reset("placeholder",10);g();return!1}}};
primitives.orgdiagram.DrawMinimizedItemsTask=function(a,b,c,d,e,f){function g(){var a=new primitives.common.PolylinesBuffer,b={},c,f=new primitives.common.Marker,g,r,w,x,t,u,z,v,y,A;for(A in l)l.hasOwnProperty(A)&&(t=l[A],u=t.actualPosition,z=d.getItemOptions(A),i.transformRect(u.x,u.y,u.width,u.height,!0,this,function(d,h,l,i){switch(t.actualVisibility){case 2:v=e.getTemplateParams(A);y=v.template.templateConfig;w=r=g=null;x=0;null!=z&&(r=g=z.itemTitleColor,w=z.minimizedItemShapeType);g=g||y.minimizedItemBorderColor||
"#ffffff";r=r||y.minimizedItemFillColor||"#ffffff";null==w&&(w=null!==y.minimizedItemShapeType?y.minimizedItemShapeType:j.minimizedItemShapeType);x=null===y.minimizedItemCornerRadius?y.minimizedItemSize.width/2:y.minimizedItemCornerRadius;null==w||6==w?(c=a.getPolyline(new primitives.common.PaletteItem({lineColor:g,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:r,opacity:y.minimizedItemOpacity})),c.addSegment(new primitives.common.DotSegment(d,h,l,i,x))):f.draw(a,w,
new primitives.common.Rect(d,h,l,i),new primitives.common.PaletteItem({lineColor:g,lineWidth:y.minimizedItemLineWidth,lineType:y.minimizedItemLineType,fillColor:r,opacity:y.minimizedItemOpacity}));break;default:k&&(g="#ff0000",b.hasOwnProperty(g)||(b[g]=new primitives.common.PaletteItem({lineColor:g,lineWidth:1,lineType:0,fillColor:g,opacity:1})),c=a.getPolyline(b[g]),c.addSegment(new primitives.common.DotSegment(d-1,h-1,2,2,1)))}}));h.activate("placeholder",9);h.polylinesBuffer(a)}var h,i,k=!1,j,
l;return{process:function(){h=a();i=b.getTransform();j=d.getOptions();l=f.getItemsPositions();h.reset("placeholder",9);g();return!1}}};
primitives.orgdiagram.DrawPrintPreviewTask=function(a,b,c,d,e,f){var g;return{process:function(){var b=c.getOptions(),i=f.getOptions();g=a();g.reset("placeholder",1);if(4==b.pageFitMode){var b=new primitives.common.Size(b.printPreviewPageSize),k,j,l=d.getContentSize(),m=e.getTemplate();b.scale(1/i.scale);g.activate("placeholder",1);for(i=0;(i+1)*b.width<l.width;){for(k=0;(k+1)*b.height<l.height;)j=g.template(i*b.width,k*b.height,b.width,b.height,0,0,b.width,b.height,m.template(),m.getHashCode(),m.render,
null,null),j.data({column:i,row:k}),k+=1;i+=1}}return!1}}};
primitives.orgdiagram.DrawShapeAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,u,z,v,y,A,B;switch(h){case 1:c=k.activate("placeholder",3);break;case 2:c=k.activate("placeholder",13)}d=0;for(f=a.length;d<f;d+=1)if(A=a[d],null!=A.items&&0<A.items.length){z=new primitives.common.Rect;e=0;for(g=A.items.length;e<g;e+=1)u=b(A.items[e]),null!=u&&z.addRect(u.actualPosition);if(!z.isEmpty()){i=new primitives.common.Shape(k);u=new primitives.orgdiagram.ShapeAnnotationConfig;v="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");
e=0;for(g=v.length;e<g;e+=1)y=v[e],i[y]=A.hasOwnProperty(y)?A[y]:u[y];i.position=z;i.orientationType=l.orientationType;i.panelSize=c.size;i.labelTemplate=m;i.hasLabel=null!=A.templateName||null!=A.label;B=new primitives.common.RenderEventArgs;B.context=A;B.templateName=i.labelTemplate;j.transformRect(z.x,z.y,z.width,z.height,!0,this,function(a,b,c,d){a=new primitives.common.Rect(a,b,c,d);i.draw(a,B)})}}}var k,j,l,m;return{process:function(){k=a();j=b.getTransform();l=d.getOptions();m=g.getTemplate();
switch(h){case 1:k.reset("placeholder",3);break;case 2:k.reset("placeholder",13)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawTreeItemsTask=function(a,b,c,d,e,f,g,h,i,k,j,l){function m(){var a,b=h.getCursorTreeItem(),c,d,f;for(f in n)n.hasOwnProperty(f)&&(c=n[f],d=c.actualPosition,1==c.actualVisibility&&q.transformRect(d.x,d.y,d.width,d.height,!0,this,function(d,j,h,l){var k=g.getTemplateParams(f),n=k.template;a=new primitives.common.RenderEventArgs;a.context=e.getConfig(f);a.isCursor=f==b;a.isSelected=i.isSelected(f);a.templateName=n.templateConfig.name;s.activate("placeholder",12);s.template(d,
j,h,l,c.contentPosition.x,c.contentPosition.y,c.contentPosition.width,c.contentPosition.height,n.itemTemplate.template(),n.itemTemplate.getHashCode(),n.itemTemplate.render,a,{"border-width":n.templateConfig.itemBorderWidth});k.hasGroupTitle&&s.template(d,j,h,l,2,c.contentPosition.y,p.groupTitlePanelSize-4,c.contentPosition.height+2,x.template(),x.getHashCode(),x.render,a,null);k.hasSelectorCheckbox&&(s.activate("placeholder",16),s.template(d,j,h,l,c.contentPosition.x,l-(p.checkBoxPanelSize-4),c.contentPosition.width,
p.checkBoxPanelSize-4,w.template(),w.getHashCode(),w.render,a,null));k.hasButtons&&(s.activate("placeholder",16),s.template(d,j,h,l,h-(p.buttonsPanelSize-4),c.contentPosition.y,p.buttonsPanelSize-4,Math.max(c.contentPosition.height,l-c.contentPosition.y),r.template(),n.templateConfig.name+r.getHashCode(),r.render,k,null))}))}var n,s,q,p,r,w,x;return{process:function(){s=a();p=d.getOptions();n=f.getItemsPositions();q=b.getTransform();r=l.getTemplate();w=j.getTemplate();x=k.getTemplate();s.reset("placeholder",
12);s.reset("placeholder",16);m();return!1}}};primitives.orgdiagram.AnnotationLabelTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.AnnotationLabelTemplate);return a}}};primitives.orgdiagram.ButtonsTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.ButtonsTemplate);return a}}};
...
primitives.orgdiagram.ItemTemplateParamsTask=function(a,b,c){function d(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d}var e={};return{process:function(){var f=a.getOptions(),g=0<f.buttons.length,h=b.getCursorItem(),i=f.items,k,j;e={};k=0;for(j=i.length;k<j;k+=1){var l=i[k],m=new primitives.orgdiagram.TemplateParams,n=h==l.id,s=c.getTemplate(l.templateName,f.defaultTemplateName,c.DefaultWidgetTemplateName),q=s.templateConfig,
p=null!=q.buttons&&0<q.buttons.length;m.template=s;m.hasSelectorCheckbox=d(n,l.hasSelectorCheckbox,f.hasSelectorCheckbox);m.hasButtons=(g||p)&&d(n,l.hasButtons,f.hasButtons);m.hasGroupTitle=!primitives.common.isNullOrEmpty(l.groupTitle);m.isActive=l.isActive&&q.isActive;m.hasButtons&&(m.buttons=p?q.buttons:f.buttons);e[l.id]=m}return!0},getTemplateParams:function(a){return e[a]}}};
...
primitives.orgdiagram.CombinedNormalVisibilityItemsTask=function(a,b,c,d,e,f,g,h,i,k,j,l){function m(a){var b=[],c,d,f,e,g,j,h={};c=0;for(d=a.length;c<d;c+=1){f=a[c];g=f.getItems();f=0;for(e=g.length;f<e;f+=1)j=g[f],h.hasOwnProperty(j)||(b.push(j),h[j]=!0)}return b}var n=[],s={},q=[b,c,d,e,f,g,h,i,k,j,l],p=new primitives.common.ArrayReader(new primitives.common.ValueReader(["string","number"],!0),!0);return{process:function(){var b={isChanged:!1,hash:s},c=a.getOptions();n=p.read(n,m(q),"items",b);
if(0==c.pageFitMode||1==c.minimalVisibility)b.isChanged=!1;return b.isChanged},isItemSelected:function(a){return s.items.hasOwnProperty(a)}}};primitives.orgdiagram.CursorItemTask=function(a,b){var c=null;return{process:function(){var d=a.getCursorItem(),e=b.getActiveTreeLevels();c=null!=d&&e.hasItem(d)?d:null;return!0},getCursorTreeItem:function(){return c},getItems:function(){return null!=c?[c]:[]}}};
...
primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask=function(a){function b(a){var b=[],c={},d,e,j,l,m,n;d=0;for(e=a.length;d<e;d+=1)if(j=a[d],j.selectItems){m=j.items;j=0;for(l=m.length;j<l;j+=1)n=m[j],null!=n&&!c.hasOwnProperty(n)&&(b.push(n),c[n]=!0)}return b}var c=[],d={},e=new primitives.common.ArrayReader(new primitives.common.ValueReader(["string","number"],!0),!0);return{process:function(){var f={isChanged:!1,hash:d},g=a.getAnnotations();c=e.read(c,b(g),"items",f);return f.isChanged},
getItems:function(){return c}}};
primitives.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask=function(a){function b(a){var b=[],c={},d,e,j;d=0;for(e=a.length;d<e;d+=1)j=a[d],j.selectItems&&(null!=j.fromItem&&!c.hasOwnProperty(j.fromItem)&&(b.push(j.fromItem),c[j.fromItem]=!0),null!=j.toItem&&!c.hasOwnProperty(j.toItem)&&(b.push(j.toItem),c[j.toItem]=!0));return b}var c=[],d={},e=new primitives.common.ArrayReader(new primitives.common.ValueReader(["string","number"],!0),!0);return{process:function(){var f={isChanged:!1,hash:d},
g=a.getAnnotations();c=e.read(c,b(g),"items",f);return f.isChanged},getItems:function(){return c}}};
primitives.orgdiagram.SelectedItemsTask=function(a){function b(a){var b=[],c={},d,e,j;d=0;for(e=a.length;d<e;d+=1)j=a[d],null!=j&&!c.hasOwnProperty(j)&&(b.push(j),c[j]=!0);return b}var c=[],d={},e=new primitives.common.ArrayReader(new primitives.common.ValueReader(["string","number"],!0),!0);return{process:function(){var f={isChanged:!1,hash:d},g=a.getSelectedItems();c=e.read(c,b(g),"items",f);return f.isChanged},getItems:function(){return c},isSelected:function(a){return d.items.hasOwnProperty(a)}}};
primitives.orgdiagram.SelectionPathItemsTask=function(a,b,c,d){function e(a,b,c){var d=[],f={},e,m,n;m=0;for(n=a.length;m<n;m+=1)switch(e=a[m],c){case 1:b.loopParents(this,e,function(a){if(null!=f[a])return b.SKIP;d.push(a);f[a]=!0})}return d}var f=[];return{process:function(){var g=d.getSelectionPathMode(),h=a.getNavigationFamily(),i=b.getCursorTreeItem(),k=c.getItems().slice(0);k.push(i);f=e(k,h,g);return!0},getItems:function(){return f}}};
primitives.orgdiagram.BackgroundAnnotationManagerTask=function(a,b,c){function d(){var a=new primitives.common.perimeter.Manager,b,c,d,g,l,h,x,t,u,z,v,y,A,B,C;if(!i.isEmpty()&&(x=[],t=[],i.loopLevels(this,function(a){v=z=null;C=k[a];4!=C.actualVisibility&&(x.push(a),A=[],i.loopLevelItems(this,a,function(a){y=j[a];4!=y.actualVisibility&&(null!=v&&f(A,z,v,y),z=v,v=y)}),null!=v&&f(A,z,v,null),t.push(A))}),0<t.length)){u=[];l=[];b=0;for(c=t.length;b<c;b+=1)l=primitives.common.mergeSort([l,t[b]],null,
!0),u.push(l),l=t[b];u.push(primitives.common.mergeSort([t[b-1]],null,!0));l=[];b=0;for(c=u.length;b<c;b+=1){h={};A=u[b];d=0;for(g=A.length;d<g;d+=1)B=A[d],h[B]=d;l.push(h)}d=[];h=B=null;b=0;for(c=x.length;b<c;b+=1)g=x[b],null!=h&&e(d,b-1,l,u,k[B],h,k[h],k[g]),B=h,h=g;null!=h&&e(d,b-1,l,u,k[B],h,k[h],null);a.add(d)}return a}function e(a,b,c,d,f,e,h,k){var t=Math.floor(l.normalItemsInterval/2),u=null!=f?Math.floor(3*(f.shift+f.depth)/7+4*h.shift/7):h.shift-t,z=null!=k?Math.floor(3*(h.shift+h.depth)/
7+4*k.shift/7):h.shift+h.depth+t,v=null,y=null,A,B;i.loopLevelItems(this,e,function(f,e){A=j[f];4!=A.actualVisibility&&(null!=y&&g(a,c[b],c[b+1],d[b],d[b+1],u,z,v,y,A,B.id),v=y,y=A,B=e)});null!=y&&g(a,c[b],c[b+1],d[b],d[b+1],u,z,v,y,null,B.id)}function f(a,b,c,d){var f=Math.floor(l.normalItemsInterval/2),b=null!=b?Math.floor(3*b.actualPosition.right()/7+4*c.actualPosition.x/7):c.actualPosition.x-f,c=null!=d?Math.floor(3*c.actualPosition.right()/7+4*d.actualPosition.x/7):c.actualPosition.right()+f;
a.push(b);a.push(c)}function g(a,b,c,d,f,e,g,j,h,i,k){var v=[],y=primitives.common.perimeter.SegmentItem,A=Math.floor(l.normalItemsInterval/2),j=null!=j?Math.floor(3*j.actualPosition.right()/7+4*h.actualPosition.x/7):h.actualPosition.x-A,h=null!=i?Math.floor(3*h.actualPosition.right()/7+4*i.actualPosition.x/7):h.actualPosition.right()+A;v.push(new y(j,e,j,g));for(i=c[j]+1;i<=c[h];i+=1)v.push(new y(f[i-1],g,f[i],g));v.push(new y(h,g,h,e));for(i=b[h]-1;i>=b[j];i-=1)v.push(new y(d[i+1],e,d[i],e));a.push(new primitives.common.perimeter.Item(k,
v))}var h=null,i,k,j,l;return{process:function(){h=null;i=b.getTreeLevels();k=c.getTreeLevelsPositions();j=c.getItemsPositions();l=a.getOptions();return!0},getBackgroundManager:function(){null==h&&(h=d());return h}}};primitives.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(c){return a.getConfig(c)||null!=b&&b.getConfig(c)}}};
primitives.orgdiagram.ConnectionsGraphTask=function(a,b,c,d,e){function f(a,b,c,d,f,e,g,j,h,l){this.polyline=c;this.from=a;this.to=b;this.weight=g||0;this.fromOffset=j||0;this.parentsArrowId=d;this.childrenArrowId=f;this.dotId=e;this.hasMiddle=h;this.middleParent=l}function g(a,b){var c=b.fromItems[0],d=b.toItems[0],e=x[c],g=x[d],j=w[b.fromLevel],h=new primitives.common.Polyline;e.actualPosition.x<g.actualPosition.x?s.transformPoints(e.actualPosition.right(),j.shift+j.horizontalConnectorsDepth,g.actualPosition.x,
j.shift+j.horizontalConnectorsDepth,!0,this,function(a,b,c,d){h.addSegment(new primitives.common.MoveSegment(a,b));h.addSegment(new primitives.common.LineSegment(c,d))}):s.transformPoints(e.actualPosition.x,j.shift+j.horizontalConnectorsDepth,g.actualPosition.right(),j.shift+j.horizontalConnectorsDepth,!0,this,function(a,b,c,d){h.addSegment(new primitives.common.MoveSegment(a,b));h.addSegment(new primitives.common.LineSegment(c,d))});g=4!==g.actualVisibility;e=4!==e.actualVisibility;a.addEdge(c,d,
new f(c,d,h,g?d:null,e?c:null,g||e?1E3:10))}function h(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}function i(){var a="_"+t;t+=1;return a}function k(a,b,c){var e=w[b.fromLevel],g=d.getConnectorsStacksSizes(b.fromLevel),l,k,m,n,p,t,N,F,I;F=0===q.connectorType;I=0<b.fromOffset?e.shift+e.connectorShift-e.levelSpace/2*(g.parentsStackSize-b.fromOffset+1):e.shift+
e.connectorShift;g=[];if(0<b.fromItems.length){k=b.fromItems;p=0;for(l=k.length;p<l;p+=1)m=k[p],n=x[m],m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter(),y:n.actualPosition.bottom(),isSquared:!0,visibility:n.actualVisibility}),g.push(m);g.sort(function(a,b){return a.x-b.x})}l=[];if(0<b.toItems.length){N=!1;k=b.toItems;for(p=0;p<k.length;p+=1){m=k[p];r.getLevelIndex(m);n=x[m];t=!0;if(c)switch(n.actualVisibility){case 2:case 3:t=F}m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter()+
0,y:n.actualPosition.top(),isSquared:t,visibility:n.actualVisibility});l.push(m);N=N||m.isSquared}l.sort(function(a,b){return a.x-b.x})}F=1==l.length?l[0].x:1==g.length?g[0].x:0<l.length&&0<g.length?(g[0].x+g[g.length-1].x+l[0].x+l[l.length-1].x)/4:0<l.length?(l[0].x+l[l.length-1].x)/2:(g[0].x+g[g.length-1].x)/2;var K=null;0<g.length&&(K=new h({id:i(),x:F,y:I}),j(a,K,g,!0,c,!0,b.fromOffset,q.showExtraArrows&&0<l.length));var G=null;0<l.length&&(G=new h({id:i(),x:F,y:e.shift+e.connectorShift}),null!=
K&&G.y==K.y&&(G=K),j(a,G,l,N,c,!1,0,q.showExtraArrows&&0<g.length));null!=K&&(null!=G&&K.id!=G.id)&&s.transformPoints(K.x,K.y,G.x,G.y,!0,this,function(b,c,d,e){var g=new primitives.common.Polyline;g.addSegment(new primitives.common.MoveSegment(b,c));g.addSegment(new primitives.common.LineSegment(d,e));a.addEdge(K.id,G.id,new f(K.id,G.id,g,null,null,null,0))})}function j(a,b,c,d,e,g,j,i){var k,m,n,p=[],t,r;if(d){p=[];d=0;for(m=c.length;d<m;d+=1)if(n=c[d],n.x<b.x&&!n.isSquared)p.push(n);else break;
m=p.length;0<m&&(n=p[m-1],n=n.x==b.x?b:new h({id:n.bundleid,x:n.x,y:b.y}),l(a,n,p,!1));p=[];for(k=c.length-1;k>=d;k-=1)if(n=c[k],n.x>b.x&&!n.isSquared)p.push(n);else break;m=p.length;0<m&&(n=p[m-1],n=n.x==b.x?b:new h({id:n.bundleid,x:n.x,y:b.y}),l(a,n,p,!1));for(p=d;p<=k;p+=1){n=c[p];m=q.bevelSize;2>m&&(m=0);if(e)switch(q.elbowType){case 2:case 3:0<m&&(Math.abs(b.x-n.x)>m&&Math.abs(b.y-n.y)>m)&&(n.hasElbow=!0,n.elbowPoint1=new primitives.common.Point(n.x,b.y+(b.y>n.y?-m:m)),n.elbowPoint2=new primitives.common.Point(n.x+
(b.x>n.x?m:-m),b.y))}t=new primitives.common.Polyline;n.hasElbow?(s.transform3Points(n.elbowPoint2.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint1.y,!0,this,function(a,b,c,d,f,e){switch(q.elbowType){case 2:t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(f,e));break;case 3:t.addSegment(new primitives.common.MoveSegment(a,b)),t.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}}),s.transformPoints(n.elbowPoint1.x,
n.elbowPoint1.y,n.x,n.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.LineSegment(c,d))})):s.transformPoints(n.x,b.y,n.x,n.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))});m=n.x==b.x?b.id:n.bundleid;r=4!==n.visibility;a.addEdge(m,n.id,new f(m,n.id,t,g&&r?n.id:null,!g&&r?n.id:null,null,r?1E3:10,j))}d=Math.max(d-1,0);k=Math.min(k+1,c.length-1);e=b;n=b.id;for(p=d;p<=k;p+=1)m=c[p],r=m.bundleid,m.x>e.x&&
(t=new primitives.common.Polyline,s.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:m.x,b.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))}),a.addEdge(n,r,new f(n,r,t,null,null,n,Math.abs(m.x-e.x)/1E4,j,i,g?r:n)),e=m,n=r);e=b;n=b.id;for(p=k;p>=d;p-=1)m=c[p],r=m.bundleid,m.x<e.x&&(t=new primitives.common.Polyline,s.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:m.x,b.y,!0,this,function(a,b,
c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))}),a.addEdge(n,r,new f(n,r,t,null,null,n,Math.abs(m.x-e.x)/1E4,j,i,g?r:n)),e=m,n=r)}else l(a,b,c,!0)}function l(a,b,c,d){var e,g,j,h,l;e=0;for(g=c.length;e<g;e+=1){h=c[e];l=new primitives.common.Polyline;s.transformPoint(b.x,b.y,!0,this,function(a,b){l.addSegment(new primitives.common.MoveSegment(a,b))});switch(q.connectorType){case 1:s.transformPoint(h.x,h.y,!0,this,function(a,b){l.addSegment(new primitives.common.LineSegment(a,
b))});break;case 2:j=new primitives.common.Rect(b,h),d?b.x>j.x?s.transform3Points(j.right(),j.verticalCenter(),j.x,j.verticalCenter(),j.x,j.bottom(),!0,this,function(a,b,c,d,f,e){l.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):s.transform3Points(j.x,j.verticalCenter(),j.right(),j.verticalCenter(),j.right(),j.bottom(),!0,this,function(a,b,c,d,f,e){l.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):b.x>j.x?s.transformPoints(j.x,j.y,j.x,j.bottom(),!0,this,function(a,
b,c,d){l.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):s.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(a,b,c,d){l.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}j=4!==h.visibility;a.addEdge(b.id,h.id,new f(b.id,h.id,l,null,j?h.id:null,j?1E3:10))}}var m=null,n,s,q,p,r,w,x,t;return{process:function(){n=a();s=b.getTransform();q=c.getOptions();p=d.getBundles();r=d.getTreeLevels();w=e.getTreeLevelsPositions();x=e.getItemsPositions();var f=primitives.common.graph(),
j=n.activate("placeholder",6),h,l;h=t=0;for(l=p.length;h<l;h+=1){var i=p[h];i.isVertical?k(f,i,j.hasGraphics):g(f,i)}m=f;return!0},getGraph:function(){return m}}};primitives.orgdiagram.IntervalsTask=function(a){var b={};return{process:function(){var c=a.getOptions();b[1]=c.normalItemsInterval;b[2]=c.dotItemsInterval;b[3]=c.lineItemsInterval;b[4]=c.lineItemsInterval;return!0},getInterval:function(a){return b[a]}}};
primitives.orgdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,k,j,l,m){var n,s,q;function p(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(F.orientationType){case 2:case 3:a.invert()}if(!E.isEmpty())switch(G.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=r(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(G.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}E.loopLevelsReversed(this,
function(a){var b;for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=r(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=r(c,0);if(!w(b,f)&&(a=0,b=r(c,c.length-1),w(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=r(c,g),w(b,f)?e=g:a=g;e!==g&&(b=r(c,e))}}return b}function r(a,b){var c,d;n=[];E.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;n.push(a)});for(c=0;c<=b;c+=1)d=a[c],n[d.level].currentvisibility=
d.currentvisibility;u();y();z();c=G.lineLevelShift;var f,e,g,j,h=d=0;f=8*I.linesWidth;switch(I.arrowsDirection){case 1:d=f;h=0;break;case 2:d=0,h=f}f=0;for(e=n.length;f<e;f+=1)g=n[f],j=i.getConnectorsStacksSizes(f),c+=g.setShift(c,v(g.actualVisibility),h,d,j.parentsStackSize);return new primitives.common.Rect(0,0,Math.round(t()),Math.round(x()))}function w(a,b){var c=!1;switch(G.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=
a.width&&(c=!0)}return c}function x(){var a=n[n.length-1];return a.shift+a.nextLevelShift}function t(){var a=0,b,c;b=0;for(c=n.length;b<c;b+=1)a=Math.max(a,n[b].currentOffset);return a+=G.normalItemsInterval}function u(){var a=l.getCursorTreeItem();s={};E.loopLevels(this,function(b){var c=n[b];E.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=m.isItemSelected(b)?1:d.visibility,g=j.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==
b,g,G,F);s[b]=f})})}function z(){var a,b;E.loopLevels(this,function(c){var d=n[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;E.loopLevelItems(this,c,function(c){c=s[c];d.depth=Math.max(d.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&
(a=b);switch(G.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function v(a){var b=0;switch(a){case 1:b=G.normalLevelShift;break;case 2:b=G.dotLevelShift;break;case 3:case 4:b=G.lineLevelShift}return b}function y(){var a,b;a=0;for(b=n.length;a<b;a+=1)n[a].currentOffset=0;H.loopPostOrder(this,function(a,b){var c=s[a],d=c.actualVisibility,f=E.getLevelIndex(a),f=n[f],d=g.getInterval(0===
d?f.currentvisibility:d)/2,e,j,h,l,i,k,m,p;e=8*I.linesWidth;c.leftPadding=d+(0<f.currentOffset?d*b.relationDegree*G.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=I.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=e),b.connectorPlacement&2&&(c.rightPadding+=e));c.offset=f.currentOffset+c.leftPadding;f.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(H.hasChildren(a))if(c=A(b),0<c)C(b,c);else if(0>c&&(c=-c,B(b,c),j=null,h={},i=null,f=H.parent(b.id),null!==f&&(H.loopChildrenReversed(this,
f.id,function(a,c){if(c===b)j=[];else if(null!==j){var d=null,f=[],e,g,k,m;e=N[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);g=0;for(k=e.length;g<k;g+=1)m=s[e[g]],f[g]=m.offset+m.actualSize.width+m.rightPadding;e=[];var n;g=L[b.id];void 0===g&&(g=[]);g=g.slice();g.splice(0,0,b.id);k=0;for(m=g.length;k<m;k+=1)n=s[g[k]],e[k]=n.offset-n.leftPadding;g=Math.min(f.length,e.length);for(k=0;k<g&&!(m=e[k]-f[k],d=null!==d?Math.min(d,m):m,0>=m);k+=1);l=Math.floor(d);h[c.id]=l;if(0<l)j.splice(0,0,c);
else return i=c,!0}}),0<j.length))){d=null;if(null!==i){k=[i];k=k.concat(j);k.push(b);d=[[i]];f=1;for(e=k.length;f<e;f+=1)m=k[f-1],p=k[f],2==m.gravity||1==p.gravity?d[d.length-1].push(p):d.push([p])}else d=[j.slice(0)],d[d.length-1].push(b);if(0<d.length){j=d[d.length-1];for(f=j.length-2;0<=f;f-=1)p=j[f],l=h[p.id],c=Math.min(l,c),B(p,c),C(p,c)}k=c/(d.length-1);for(e=d.length-2;0<e;e-=1){m=d[e];for(f=m.length-1;0<=f;f-=1)p=m[f],l=h[p.id],c=Math.min(e*k,Math.min(l,c)),B(p,c),C(p,c)}}})}function A(a){var b=
s[a.id],b=b.offset+b.actualSize.width/2,c=null,d,f,e;if(null===a.visualAggregatorId)switch(d=null,H.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),f=s[d.id],e=null,H.loopChildrenReversed(this,a.id,function(a,b){e=b;if(e.connectorPlacement&1)return!0}),a=s[e.id],K.horizontalAlignment){case 1:c=f.offset+f.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(f.offset+a.offset+a.actualSize.width)/2}else a=s[a.visualAggregatorId],c=a.offset+a.actualSize.width/
2;return b-c}function B(a,b){var c=s[a.id];c.offset+=b;var d=n[E.getLevelIndex(a.id)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width+c.rightPadding)}function C(a,b){var c,d;H.loopLevels(this,a.id,function(a){c=s[a];c.offset+=b;d=n[E.getLevelIndex(a)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width);return!0})}function D(){E.loopLevels(this,function(a){var b=n[a];E.loopLevelItems(this,a,function(a){s[a].setPosition(b,G,F)})})}s={};n=[];q=null;var E,H,L,N,
F,I,K,G,J;return{process:function(){var g;G=d.getOptions();F=c.getOptions();I=e.getOptions();K=f.getOptions();E=i.getTreeLevels();H=h.getVisualTree();L=k.getLeftMargins();N=k.getRightMargins();n=[];s={};g=a.getOptimalPanelSize();J=b.getOptions();g.scale(1/J.scale);g=new primitives.common.Rect(0,0,g.width,g.height);q=p(g);D();return!0},getTreeLevelsPositions:function(){return n},getItemsPositions:function(){return s},getItemPosition:function(a){return s[a]},getContentSize:function(){return q}}};
primitives.orgdiagram.OrgTreeTask=function(a){var b,c;function d(a){var d,h,i,k,j,l=0,m,n=primitives.common.tree();k=0;for(j=a.length;k<j;k+=1)i=a[k],null!=i.id&&(d=new primitives.orgdiagram.OrgItem(i),m=parseInt(i.id,10),l=Math.max(isNaN(m)?0:m,l),n.add(i.parent,d.id,d));l+=1;a=new primitives.orgdiagram.ItemConfig;a.id=l;a.title="internal root";a.isVisible=!1;a.isActive=!1;h=new primitives.orgdiagram.OrgItem(a);h.hideParentConnection=!0;h.hideChildrenConnection=!0;n.add(null,h.id,h);n.loopLevels(this,
...
primitives.orgdiagram.VisualTreeLevelsTask=function(a,b){function c(a,b,c,d){var f,e,g,h,p,r,w,x={},t,u,z;c.loopLevels(this,function(v){var y=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[v]=y;w=[];c.loopLevelItems(this,v,function(b,f){var e=[];if(!x.hasOwnProperty(b)&&(f.connectorPlacement&4&&e.push(b),e=e.concat(f.partners),0<e.length)){r=new primitives.orgdiagram.ConnectorBundle;r.fromLevel=v;r.fromItems=e;r.toItems=[];for(var g=0,h=e.length;g<h;g+=1)x[e[g]]=r;d.loopChildren(this,b,function(a,
b){b.connectorPlacement&1&&r.toItems.push(a)});1<e.length&&w.push(r);(1<r.fromItems.length||0<r.toItems.length)&&a.push(r)}f.connectorPlacement&8&&(r=new primitives.orgdiagram.ConnectorBundle,r.isVertical=!1,r.fromLevel=v,r.fromItems=[b],r.toItems=[c.getPrevItem(b)],a.push(r));f.connectorPlacement&2&&(r=new primitives.orgdiagram.ConnectorBundle,r.isVertical=!1,r.fromLevel=v,r.fromItems=[b],r.toItems=[c.getNextItem(b)],a.push(r))});if(0<w.length){z=primitives.common.pile();f=0;for(e=w.length;f<e;f+=
1){r=w[f];u=t=null;g=0;for(h=r.fromItems.length;g<h;g+=1)p=c.getItemPosition(r.fromItems[g]),t=null!=t?Math.min(t,p):p,u=null!=u?Math.max(u,p):p;z.add(t,u,r)}y.parentsStackSize=z.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}var d=null,e=null,f=null,g=null,h=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var h=a.getVisualTree();d=primitives.common.TreeLevels();e=primitives.common.TreeLevels();h.loopLevels(this,function(a,c,f){var g=b.getTemplateParams(a);d.addItem(f,
...
primitives.orgdiagram.VisualTreeMarginsTask=function(a){function b(a,b,c){a.loop(this,function(a){b[a]=[];c[a]=[]});a.loopPostOrder(this,function(a,d,e){var d=b[e],j=c[e],l=b[a],m=c[a],n;if(null!=e){d[0]||(d[0]=a);e=0;for(n=l.length;e<n;e+=1)d[e+1]||(d[e+1]=l[e]);j[0]=a;e=0;for(n=m.length;e<n;e+=1)j[e+1]=m[e]}})}var c={},d={};return{process:function(){c={};d={};b(a.getVisualTree(),c,d);return!0},getLeftMargins:function(){return c},getRightMargins:function(){return d}}};
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,r,y,A,B,C,D,E,H,L,N,F={},I,K={},G,J,O,Z={},$;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,r,E;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=s({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));O=J=0;if(null!=
(B=c.indexOf(f)))J=B,O=c.countSiblings(f)-B-1;r=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=s({parentId:f,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:q(i,e),e.connectorPlacement=5,E=s({visibility:4}),c.add(E.id,e.id,e),e=E;case 8:case 2:g=c.parent(f);if(i.connectorPlacement&2)y=l(c,p.navigationFamily,i),c.add(g.id,
e.id,e,y+1),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)A=m(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:y=l(c,p.navigationFamily,i);c.add(g.id,e.id,e,y+1);e.connectorPlacement=6;e.gravity=2;break;default:A=m(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0);break;case 2:q(i,e)}break;case 4:q(i,
e),e.connectorPlacement=5,E=s({visibility:4}),c.add(E.id,e.id,e),e=E;case 1:null===i.visualAggregatorId&&n(c,i,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&q(i,e);break;case 0:r.push(e);q(i,e);break;case 7:case 6:g=c.parent(f);if(i.connectorPlacement&2)c.add(g.id,e.id,e,J),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
O),e.connectorPlacement=12,e.gravity=1;else{switch(b.adviserPlacementType){case 2:c.add(g.id,e.id,e,J);e.gravity=2;break;default:c.add(g.id,e.id,e,c.countChildren(g.id)-O),e.gravity=1}switch(e.actualItemType){case 6:e.connectorPlacement=5;break;case 7:e.connectorPlacement=4}}null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0)}}});switch(i.actualItemType){case 7:case 8:case 6:break;default:$=[],null!=(g=c.parent(f))&&c.loopChildrenRange(this,g.id,J,c.countChildren(g.id)-O,function(b,c){if(c.id==f)$.push(c);
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&$.push(c)}}),1<$.length&&(Z[f]=$)}F[f]=[];K[f]=[];var D=i,v=h.childrenPlacementType,H=F[f],N=K[f],L,C,I,G,U,ba,P,M,Y=4==D.visibility&&0===D.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:C=3;break;case 2:C=2}0===v&&(v=j(a,D)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);L=D;null!==D.visualAggregatorId&&(L=c.node(D.visualAggregatorId));3==v&&3>r.length&&
(v=2);switch(v){case 2:v=0;for(G=r.length;v<G;v+=1)D=r[v],H=a.node(D.id),c.add(L.id,D.id,D),D.connectorPlacement=(H.hideParentConnection?0:1)|(H.hideChildrenConnection?0:4),0===v&&(D.relationDegree=1);break;case 3:G=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(r.length)));U=Math.ceil(r.length/G);ba=Math.ceil(G/2);for(P=0;P<ba;P+=1){C=L;for(M=0;M<U;M+=1){D=k(r,2*P,M,G);v=k(r,2*P+1,M,G);void 0===H[M]&&(H[M]=[],N[M]=[]);null!==D&&(0===P&&(D.relationDegree=1),c.add(C.id,D.id,D),D.connectorPlacement=
(Y?0:2)|4,D.gravity=2,N[M].push(D));if(null!==D||null!==v)I=s({visibility:4,connectorPlacement:Y?0:5}),c.add(C.id,I.id,I),H[M].push(I);null!==v&&(c.add(C.id,v.id,v),v.connectorPlacement=(Y?0:8)|4,v.gravity=1,N[M].push(v));C=I}}2<G&&(L.visualAggregatorId=null);break;case 1:v=0;for(G=r.length;v<G;v+=1){D=r[v];I=s({visibility:4,connectorPlacement:Y?0:5});switch(C){case 2:c.add(L.id,D.id,D);c.add(L.id,I.id,I);D.connectorPlacement=(Y?0:2)|4;D.gravity=2;break;case 3:c.add(L.id,I.id,I),c.add(L.id,D.id,D),
D.connectorPlacement=(Y?0:8)|4,D.gravity=1}H[v]=[I];N[v]=[D];L=I}break;default:throw"Children placement is undefined!";}});a.loopPostOrder(this,function(a){var b=c.node(a),d,e,g;if(null!=b){d=K[a];e=F[a];H=h(c,b);if(0<H&&(b.visualDepth=H+1,null!==b.visualAggregatorId)){r=c.node(b.visualAggregatorId);g=c.hasChildren(r.id);for(B=0;B<H-1;B+=1)r=n(c,r,!g)}g=0;var j=c.parent(b.id),l,k,m;if(null!==j){l=c.indexOf(b.id);for(k=1;null!=(m=c.getChild(j.id,l+k));)if(m.connectorPlacement&8)g=Math.max(g,i(c,m)),
k+=1;else break;for(k=1;null!=(m=c.getChild(j.id,l-k));)if(m.connectorPlacement&2)g=Math.max(g,i(c,m)),k+=1;else break}H=g;if(1<H){b.visualDepth+=H-1;g=c.hasChildren(a);r=b;for(B=0;B<H-1;B+=1)r=n(c,r,!g)}L=[];B=0;for(C=d.length;B<C;B+=1){G=d[B];D=L[B]=0;for(E=G.length;D<E;D+=1)L[B]=Math.max(L[B],i(c,G[D]))}B=0;for(C=L.length;B<C;B+=1)if(N=L[B],1<N){D=0;for(E=e[B].length;D<E;D+=1)if(I=e[B][D],c.hasChildren(I.id))for(H=N;1<H;)I=n(c,I,!1),H-=1}null!=Z[a]&&f(c,b,Z[a])}})}function f(a,b,c){var d,e,f,j,
h=0,i=[],k,m;e=0;for(f=c.length;e<f;e+=1)d=c[e],h=Math.max(h,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];k=g(a,d);j=1;for(m=d;null!=m.visualAggregatorId;)m=a.node(m.visualAggregatorId),m.connectorPlacement=5,j+=1;for(;j<h;)k=n(a,k,!1),j+=1;i.push(g(a,k).id)}m=g(a,b);if(a.hasChildren(m.id)){k=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(k.id);f=l(a,p.navigationFamily,k);j=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;k=s({visibility:4,connectorPlacement:k.connectorPlacement&
10,gravity:j});a.add(e.id,k.id,k,f+1);for(j=1;j<h;)k=n(a,k,!1),k.connectorPlacement=0,j+=1}e=0;for(f=c.length;e<f;e+=1)d=c[e],p.navigationFamily.loopChildren(this,b.id,function(a,c){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;default:b.id!=d.id&&q(d,c)}return p.navigationFamily.SKIP});k=g(a,k);a.moveChildren(m.id,k.id)}k.partners=i}function g(a,b){for(var c=b;null!=c.visualAggregatorId;)c=a.node(c.visualAggregatorId);return c}function h(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,
b.id,function(d,e,f){if(b.visualAggregatorId==d)return a.SKIP;c=f+1});return c}function i(a,b){var c=0;a.loopLevels(this,b.id,function(a,b,d){c=d+1});return c+1}function k(a,b,c,d){0<d%2&&(b===d-1?b=a.length:b===d&&(b=d-1));b=c*d+b;return b>a.length-1?null:a[b]}function j(a,b){var c=!1,d=!0;a.loopChildren(this,b.id,function(b,e){c=!0;if(0===e.itemType&&a.hasChildren(b))return d=!1,!0});return c&&d}function l(a,b,c){var d=null,e={},f=a.parent(c.id);a.loopChildrenReversed(this,f.id,function(a,f,g){if(null===
d)a==c.id&&(d=-1,e[c.id]=!0,b.loopChildren(this,c.id,function(a,c,d){if(0<d)return b.BREAK;e[a]=!0}));else if(e.hasOwnProperty(a))b.loopChildren(this,f.id,function(a,c,d){if(0<d)return b.BREAK;e[a]=!0});else return d=g,!0});return d}function m(a,b,c){var d=null,e={},f=a.parent(c.id);a.loopChildren(this,f.id,function(a,f,g,j){if(null===d)a==c.id&&(d=j+1,e[c.id]=!0,b.loopChildren(this,c.id,function(a,c,d){if(0<d)return b.BREAK;e[a]=!0}));else if(e.hasOwnProperty(a))b.loopChildren(this,a,function(a,
c,d){if(0<d)return b.BREAK;e[a]=!0});else return d=g,!0});return d}function n(a,b,c){c=s({visibility:4,visualAggregatorId:b.visualAggregatorId,connectorPlacement:4==b.visibility&&0===b.connectorPlacement||c?0:5});a.insert(b.id,c.id,c);b.visualAggregatorId=c.id;return c}function s(a,b){var c=new primitives.orgdiagram.TreeItem,d;for(d in a)a.hasOwnProperty(d)&&(c[d]=a[d]);null!=b?(c.id=b.id,c.visibility=b.isVisible?0:4):(r+=1,c.id=r);return c}function q(a,c,d){var e=[];d||4==a.visibility||!b.getTemplateParams(a.id).isActive?
...
primitives.common.ButtonsTemplate=function(){var a,b=jQuery("<ul></ul>");b.css({position:"absolute"}).addClass("ui-widget ui-helper-clearfix");a=b.wrap("<div>").parent().html();var c=primitives.common.hashCode(a);return{template:function(){return a},getHashCode:function(){return c},render:function(a,b){var c=0,g,h=b.buttons,i,k;switch(b.renderingMode){case 0:for(k=0;k<h.length;k+=1)g=h[k],i=jQuery('<li data-buttonname="'+g.name+'"></li>').css({position:"absolute",top:c+"px",left:"0px",width:g.size.width+
...
primitives.common.ItemTemplate=function(a,b){
    ...
    //Se modificó la plantilla que traía por defecto la biblioteca, para ajustarla al diseño propuesto
    var d,e=new primitives.common.Size(b.itemSize),f,g,h,j,k;
    e.width-=2*b.itemBorderWidth;
    e.height-=2*b.itemBorderWidth;
    f=jQuery("<div></div>")
    .css({
        "border-width":b.itemBorderWidth+"px"})
    .addClass("bp-item bp-corner-all bt-item-frame");
    g=jQuery('<div name="titleBackground"></div>')
    .css({
        top:"3px",
        left:"2px",
        width:e.width-3+"px",
    ...
    .addClass("bp-item bp-corner-all bp-title-frame left-2");
    f.append(g);
    h=jQuery('<div name="title"></div>')
    .css({
        top:"5px",
        left:"6px",
        width:e.width-4-8+"px",
        height:"18px",
        textAlign:"center"})
    .addClass("bp-item bp-title");
    g.append(h);
    d=f.wrap("<div>").parent().html();
var i=primitives.common.hashCode(c);
    return{
        template:c,getHashCode:function(){
            return i
        },render:function(b,c){
            var d=c.context,e=null!=d.itemTitleColor?d.itemTitleColor:"#4169e1",f=primitives.common.highestContrast(e,a.itemTitleSecondFontColor,a.itemTitleFirstFontColor);c.element.find("[name=titleBackground]").css({background:e,  left: '6px'});
            
            c.element.find("[name=title]").css({
                color:f}).text(d.title);
        }}};
...
/* primitives.common.ItemTemplate=function(a,b){
    ...
    f.append(g);
    h=jQuery('<img name="photo" alt=""></img>')
    .css({
        width:"50px",
        height:"60px",
        borderStyle: 'solid',
    ...
    g.append(h);
    e=jQuery(  '<div class="bp-item" style="top: 31px; left: 65px; width: 116px; height: 22px; font-size: 11px; display:flex; flex-direction: column" >'
    ...
    + '<div name="nose" class="felipe bp-item" style="top: 130px; left: -19px; width: 210px; height: 78px; font-size: 11px;">'+'</div>');
    f.append(e);
    d=f.wrap("<div>").parent().html();
var i=primitives.common.hashCode(c);
    return{
        template:c,getHashCode:function(){
            ...
            var d=c.context,e=null!=d.itemTitleColor?d.itemTitleColor:"#4169e1",f=primitives.common.highestContrast(e,a.itemTitleSecondFontColor,a.itemTitleFirstFontColor);c.element.find("[name=titleBackground]").css({background:e,  left: '6px'});
            c.element.find("[name=photo]").attr({
                src:d.image,alt:d.title});
            c.element.find("[name=title]").css({
                color:f}).text(d.title);
            c.element.find("[name=age]").text(d.age + " años");
            c.element.find("[name=antiquity]").text(d.antiquity);
            c.element.find("[name=salary]").text(d.salary);
            c.element.find("[name=contract]").text(d.contract);
            var list = d.competences;
            var code = "<ul>";                        
            for (let index=0; index<list.length;index++) {
                code= code + "<li style='align:justify'>" + list[index] + "</li>";               
            }
            code = code + "</ul>";            
            c.element.find("[name=nose]").html(code);
        }}}; */
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,x);break;case 2:a=x;p.layout.forceCenterOnCursor=!1;p.tasks.process("HighlightItemOptionTask",null,a);p.graphics.end();break;default:null!=p.mouse&&p.mouse.destroy();k(p.layout);p.layout.element.find("."+p.name).remove();var a=p.layout,b=p.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),r=new primitives.common.Rect(e),y=a.element.offset(),A;A=jQuery('<div tabindex="0"></div>');
A.css({position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px",padding:"0px","margin-bottom":"0px","margin-right":"0px","margin-top":-y.top+Math.floor(y.top)+"px","margin-left":-y.left+Math.floor(y.left)+"px"});A.addClass(b);e=jQuery("<div></div>");e.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});e.addClass(b);e.css(r.getCSS());y=jQuery("<div></div>");y.css({position:"absolute",overflow:"hidden",top:"0px",
left:"0px"});y.addClass("placeholder");y.addClass(b);y.css(r.getCSS());r=jQuery("<div></div>");r.css({position:"absolute",overflow:"visible"});r.addClass("calloutplaceholder");r.addClass(b);r.css({top:"0px",left:"0px",width:"0px",height:"0px"});A.append(e);e.append(y);y.append(r);a.element.append(A);a.scrollPanel=A;a.mousePanel=e;a.placeholder=y;a.calloutPlaceholder=r;p.options.enablePanning&&(p.mouse=new primitives.common.Mouse,p.mouse.init(p.layout.mousePanel,{name:p.name,onMouseDrag:j,onMouseStop:l,
onMouseCapture:m}));a=p.layout;a.mousePanel.mousemove(function(a){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,b=a.pageY-b.top,d=p.tasks.getTask("CreateTransformTask"),e=p.tasks.getTask("HighlightItemOptionTask");if(!p.mouse||!p.mouse.isStarted())w=!1,e.hasHighlightEnabled()&&(c=d.getTreeItemForMousePosition(c,b,e.getGravityRadius()),n(a,c))}).click(function(a){if(!p.mouse||!p.mouse.isStarted()){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,e=a.pageY-b.top,f=p.tasks.getTask("CreateTransformTask"),
b=p.tasks.getTask("CursorItemOptionTask"),g=p.tasks.getTask("HighlightItemOptionTask"),c=f.getTreeItemForMousePosition(c,e,g.getGravityRadius()),j;null!==c&&!w&&(e=jQuery(a.target),e.hasClass(p.name+"button")||0<e.parent("."+p.name+"button").length?(j=e.hasClass(p.name+"button")?e:e.parent("."+p.name+"button"),j=j.data("buttonname"),j=d(p,null,c,j),q("onButtonClick",a,j)):"selectiontext"!==e.attr("name")&&("checkbox"===e.attr("name")?(b=(p.options.selectedItems||[]).slice(0),j=d(p,null,c,j),q("onSelectionChanging",
a,j),e=primitives.common.indexOf(b,c),0<=e?b.splice(e,1):b.push(c),p.options.selectedItems=b,q("onSelectionChanged",a,j)):(j=d(p,null,c,void 0),q("onMouseClick",a,j),!j.cancel&&b.hasCursorEnabled()&&(s(a,c),p.layout.scrollPanel.focus()))))}w=!1}).dblclick(function(a){var b;b=p.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&!w&&(b=d(p,null,b,void 0),q("onMouseDblClick",a,b));w=!1});a.scrollPanel.keydown(function(a){var b=p.tasks.getTask("HighlightItemTask"),c=p.tasks.getTask("HighlightItemOptionTask"),
d=p.tasks.getTask("CursorItemTask"),e=p.tasks.getTask("CursorItemOptionTask"),f=p.tasks.getTask("AlignDiagramTask"),g=p.tasks.getTask("CreateTransformTask").getTransform(),j=null,h,l=null,i=p.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(j=b.getHighlightTreeItem(),null===j&&(j=d.getCursorTreeItem())):c.hasHighlightEnabled()?j=b.getHighlightTreeItem():e.hasCursorEnabled()&&(j=d.getCursorTreeItem());if(null!=j){switch(a.which){case 13:e.hasCursorEnabled()&&(s(a,j),a.preventDefault(),i.scrollPanel.focus());
break;case 40:l=1;break;case 38:l=0;break;case 37:l=2;break;case 39:l=3}if(null!=l){for(b=!1;!b;){b=!0;l=g.getOrientation(l);switch(l){case 0:h=f.getNextLevelTreeItem(j,!1);break;case 1:h=f.getNextLevelTreeItem(j,!0);break;case 2:h=f.getNextTreeItem(j,!0);break;case 3:h=f.getNextTreeItem(j,!1)}null!=h&&(a.preventDefault(),c.hasHighlightEnabled()?n(a,h):e.hasCursorEnabled()&&s(a,h))}i.scrollPanel.focus()}}});p.tasks=c(g,h,i);p.graphics=primitives.common.createGraphics(p.options.graphicsType,p.layout.element);
p.graphics.debug=x;f(!0,x)}}function f(a,b){var c;p.layout.forceCenterOnCursor=a;p.tasks.process("OptionsTask",null,b);p.graphics.end();a&&(c=p.tasks.getTask("CenterOnCursorTask"),c=c.getPlaceholderOffset(),p.layout.scrollPanel.scrollLeft(c.x),p.layout.scrollPanel.scrollTop(c.y))}function g(){return p.options}function h(){return p.graphics}function i(){return p.layout}function k(a){null!=a.mousePanel&&(a.mousePanel.unbind("mousemove"),a.mousePanel.unbind("click"),a.mousePanel.unbind("dblclick"));
null!=a.scrollPanel&&a.scrollPanel.unbind("keydown")}function j(a){var b=new primitives.common.Point(a.pageX,a.pageY),a=-b.x+r.x,b=-b.y+r.y,c=p.layout.scrollPanel;c.css("visibility","hidden");c.scrollLeft(a).scrollTop(b);c.css("visibility","inherit");return!1}function l(){w=!0}function m(a){var b=p.layout.scrollPanel;r=new primitives.common.Point(b.scrollLeft()+a.pageX,b.scrollTop()+a.pageY);return!0}function n(a,b){var c=!0,e;null!==b?b!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,b,
void 0),p.options.highlightItem=b,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e))):null!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,null,void 0),p.options.highlightItem=null,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e)));return c}function s(a,b){var c;b!==p.options.cursorItem&&(c=d(p,p.options.cursorItem,b,void 0),p.options.cursorItem=b,q("onCursorChanging",a,c),c.cancel||(f(!0,x),q("onCursorChanged",a,c)))}function q(a,
b,c){a=p.options[a];null!=a&&a(b,c)}var p={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:a,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},r,w,x=!1;e();return{destroy:function(){k(p.layout);p.layout.element.find("."+p.name).remove();p.tasks=null;p.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(p.options[b]=a[b])},getOptions:g,setOption:function(a,b){return p.options[a]=b},getOption:function(a){return p.options[a]},
...
"#ffffff");f.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ConnectorsOptionTask,"#ffffff");f.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],primitives.orgdiagram.ItemsOptionTask,"#ffffff");f.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],primitives.orgdiagram.ItemsSizesOptionTask,"#ffffff");f.addTask("LabelsOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],primitives.orgdiagram.LabelsOptionTask,
"#ffffff");f.addTask("PrintPreviewOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.PrintPreviewOptionTask,"#ffffff");f.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],primitives.orgdiagram.TemplatesOptionTask,"#ffffff");f.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.OrientationOptionTask,"#ffffff");f.addTask("VisualTreeOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.VisualTreeOptionTask,
"#ffffff");f.addTask("MinimizedItemsOptionTask",["OptionsTask"],primitives.orgdiagram.MinimizedItemsOptionTask,"#ffffff");f.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorItemOptionTask,"#ffffff");f.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.HighlightItemOptionTask,"#ffffff");f.addTask("SelectedItemsOptionTask",["OptionsTask"],primitives.orgdiagram.SelectedItemsOptionTask,"#ffffff");f.addTask("CursorSelectionPathModeOptionTask",
["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorSelectionPathModeOptionTask,"#ffffff");f.addTask("SplitAnnotationsOptionTask",["OptionsTask"],primitives.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");f.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");f.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig",
"background"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");f.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");f.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");f.addTask("ForegroundConnectorAnnotationOptionTask",
["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");f.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");f.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#ffffff");
f.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#ffffff");f.addTask("CombinedContextsTask",["ItemsOptionTask"],primitives.orgdiagram.CombinedContextsTask,"#00ffff");f.addTask("IntervalsTask",["ItemsSizesOptionTask"],primitives.orgdiagram.IntervalsTask,"#00ffff");f.addTask("OrgTreeTask",["ItemsOptionTask"],primitives.orgdiagram.OrgTreeTask,"#ff0000");f.addTask("ReadTemplatesTask",["TemplatesOptionTask"],primitives.orgdiagram.ReadTemplatesTask,"#00ffff");
...
primitives.orgdiagram.DrawItemLabelsTask,"#008000");f.addTask("DrawPrintPreviewTask","graphics ApplyLayoutChangesTask PrintPreviewOptionTask AlignDiagramTask PrintPreviewTemplateTask ScaleOptionTask".split(" "),primitives.orgdiagram.DrawPrintPreviewTask,"#008000");return f},function(a,b,e,f){var g=new primitives.orgdiagram.EventArgs,h=a.tasks.getTask("CombinedContextsTask"),i=a.tasks.getTask("AlignDiagramTask"),b=h.getConfig(b),k=h.getConfig(e);b&&null!=b.id&&(g.oldContext=b);k&&null!=k.id&&(g.context=
k,null!==k.parent&&(g.parentItem=h.getConfig(k.parent)),h=a.layout.mousePanel.offset(),a=a.layout.element.offset(),e=i.getItemPosition(e),g.position=(new primitives.common.Rect(e.actualPosition)).translate(h.left,h.top).translate(-a.left,-a.top));null!=f&&(g.name=f);return g})};primitives.common.perimeter.Item=function(a,b){var c,d,e;this.id=a;this.segments=new primitives.common.LinkedHashItems;if(null!=b){c=0;for(d=b.length;c<d;c+=1)e=b[c],this.segments.add(e.key,e)}};
primitives.common.perimeter.Manager=function(a){function b(a){var b,g,h;b=0;for(g=a.length;b<g;b+=1)h=a[b],c[h.id]=h,h.segments.iterate(function(a){d[a.key]=h})}var c={},d={};null!=a&&b(a);return{add:b,getMergedPerimeters:function(a){var b=[],g={},h,i,k,j,l,m;h=0;for(i=a.length;h<i;h+=1)k=a[h],g[k]=!c.hasOwnProperty(k);h=0;for(i=a.length;h<i;h+=1)if(k=a[h],!g[k]){g[k]=!0;j=new primitives.common.perimeter.Item(k);k=c[k];k.segments.iterate(function(a){j.segments.add(a.key,a)});b.push(j);for(l=j.segments.startKey();null!=
l;){m=j.segments.item(l);d.hasOwnProperty(m.oppositeKey)&&(k=d[m.oppositeKey],g.hasOwnProperty(k.id)&&!g[k.id]&&(g[k.id]=!0,k.segments.iterateBack(function(a){a.key!=m.oppositeKey&&j.segments.insertAfter(l,a.key,a)},m.oppositeKey,null),k.segments.iterateBack(function(a){j.segments.insertAfter(l,a.key,a)},null,m.oppositeKey)));k=j.segments;for(var n=m,s=k.nextKey(n.key),q=void 0;null!=n&&n.oppositeKey==(q=s||k.startKey());)null!=s&&(s=k.nextKey(s)),k.remove(n.key),k.remove(q),n=k.item(null!=s?k.prevKey(s):
k.endKey());l=s}}return b}}};
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,k,j,l,m,n,s,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];k=d.length;j=e.length;i=h=0;s=m=n=l=null;0<k&&(l=d[h],n=!b?l:b(l));0<j&&(m=e[i],s=!b?m:b(m));for(q=null;h<k||i<j;)if(h>=k){if(!c||q!=m)f.push(m),q=m;i+=1;i<j&&(m=e[i],s=!b?m:b(m))}else if(i>=j){if(!c||q!=l)f.push(l),q=l;h+=1;h<k&&(l=d[h],n=!b?l:b(l))}else if(n<s){if(!c||q!=l)f.push(l),q=l;h+=1;h<k&&(l=d[h],n=!b?l:b(l))}else{if(!c||q!=m)f.push(m),
q=m;i+=1;i<j&&(m=e[i],s=!b?m:b(m))}d=f}}return d};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0===d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
primitives.common.SpatialIndex=function(a){function b(a,b){this.minimum=a;this.maximum=b;this.quadTree=primitives.common.QuadTree(b)}var c=[];a.sort();switch(a.length){case 0:case 1:c.push(new b(0,1E8));break;case 2:var d=a[0],a=a[1];a>2*d?(c.push(new b(0,d)),c.push(new b(d,a))):c.push(new b(0,a));break;default:for(var d=primitives.common.getLiniarBreaks(a),e=0,f=0;f<d.length;f+=1){var g=a[d[f]];c.push(new b(e,g));e=g}}return{addRect:function(a){for(var b=Math.max(a.width,a.height),d=a.centerPoint(),
e=0,f=c.length;e<f;e+=1){var g=c[e];if(b<=g.maximum||e==f-1){d.context=a;g.quadTree.addPoint(d);break}}},loopArea:function(a,b,d){if(null!=d)for(var e=0,f=c.length;e<f;e+=1){var g=c[e],n=new primitives.common.Rect(b);n.offset(g.maximum/2);g.quadTree.loopArea(this,n,function(c){c=c.context;b.overlaps(c)&&d.call(a,c)})}}}};
...
-1==e.balance?(a.balance=0,e.balance=0):(a.balance=1,e.balance=-1);else switch(e=a.left,f=e.right,c(f,e),d(e,a),a.balance=0,f.balance){case -1:f.balance=0;e.balance=1;break;case 0:f.balance=0;e.balance=0;break;default:f.balance=-1,e.balance=0}return b}function c(a,b){f(a,b);b.right=a.right;a.right=a.left;a.left=b.left;b.left=a}function d(a,b){f(a,b);b.left=a.left;a.left=a.right;a.right=b.right;b.right=a}function e(a,b){var c=null!=a.right?a.right:a.left;null!=b?b.value>a.value?b.left=c:b.right=c:
k=c}function f(a,b){var c=a.value;a.value=b.value;b.value=c;c=a.context;a.context=b.context;b.context=c}function g(a,b,c){if(null!=c){for(var d=[],e=null,e=k;null!=e;)e.value>b||null==b?(d.push(e),e=e.left):e=e.right;for(;null!=(e=d.pop())&&!c.call(a,e.value,e.context);)for(e=e.right;null!=e;)if(null!=e.left)d.push(e),e=e.left;else{if(c.call(a,e.value,e.context))return;e=e.right}}}function h(a,b,c){if(null!=c){for(var d=[],e=null,e=k;null!=e;)e.value<b||null==b?(d.push(e),e=e.right):e=e.left;for(;null!=
(e=d.pop())&&!c.call(a,e.value,e.context);)for(e=e.left;null!=e;)if(null!=e.right)d.push(e),e=e.right;else{if(c.call(a,e.value,e.context))return;e=e.left}}}function i(a){var b=[],c=0;if(null!=a)for(b.push(a);0<b.length;){for(var d=[],e=0;e<b.length;e+=1)a=b[e],null!=a.left&&d.push(a.left),null!=a.right&&d.push(a.right);b=d;c+=1}return c}var k=null;return{add:function(c,d){if(null==k)k=new a(c,d);else{for(var e=[],f=null,g=k;null!=g;){null!=f&&e.push(f);f=g;if(f.value==c)throw"Structure does not support duplicates.";
g=f.value>c?f.left:f.right}e.push(f);g=new a(c,d);f.value>c?f.left=g:f.right=g;for(f=g;null!=(g=e.pop());){if(f.value<g.value)if(0>g.balance){g.balance-=1;b(g);break}else{if(0<g.balance){g.balance-=1;break}g.balance-=1}else if(0<g.balance){g.balance+=1;b(g);break}else{if(0>g.balance){g.balance+=1;break}g.balance+=1}f=g}}},remove:function(a){for(var c=[],d=k;null!=d;)if(d.value==a){if(null!=d.right&&null!=d.left){c.push(d);for(a=d.right;null!=a.left;)c.push(a),a=a.left;var f=a;d.value=f.value;d.context=
f.context;e(a,c[c.length-1]);c.push(a)}else e(d,c[c.length-1]),c.push(d);for(a=c.length-2;0<=a;a-=1)if(f=c[a],d=c[a+1],f.value>d.value)if(0<f.balance){if(f.balance+=1,0===b(f))break}else{if(0===f.balance){f.balance+=1;break}f.balance+=1}else if(0>f.balance){if(f.balance-=1,0===b(f))break}else{if(0===f.balance){f.balance-=1;break}f.balance-=1}break}else c.push(d),d=d.value>a?d.left:d.right},loopForward:g,loopBackward:h,nextContext:function(a){var b=null;g(this,a,function(a,c){b=c;return!0});return b},
previousContext:function(a){var b=null;h(this,a,function(a,c){b=c;return!0});return b},validate:function(){if(null!=k)for(var a=[k];0<a.length;){for(var b=[],c=0;c<a.length;c+=1){var d=a[c];if(null==d.value||null!=d.left&&(b.push(d.left),d.left.value>=d.value)||null!=d.right&&(b.push(d.right),d.right.value<=d.value))return!1;if(d.balance!=i(d.right)-i(d.left))return console.log("Disbalanced node: "+d.value+" - "+JSON.stringify(k)),!1}a=b}return!0}}};
...
primitives.common.QuadTree=function(a){function b(a){this.quadrants=[];this.points=[];this.position=a}function c(a){var c=f[e].position,d=null;switch(a){case 0:d=new primitives.common.Rect(c.x,c.y,2*c.width,2*c.height);break;case 1:d=new primitives.common.Rect(c.x-c.width,c.y,2*c.width,2*c.height);break;case 2:d=new primitives.common.Rect(c.x,c.y-c.height,2*c.width,2*c.height);break;case 3:d=new primitives.common.Rect(c.x-c.width,c.y-c.height,2*c.width,2*c.height)}c=new b(d);c.quadrants=[];c.quadrants[a]=
e;f[g]=c;e=g;g+=1}function d(a,c){var d=a.position,e=d.horizontalCenter(),l=d.verticalCenter(),m=d.width/2,n=d.height/2,s=g,q=null;switch(c){case 0:q=new primitives.common.Point(d.x,d.y);break;case 1:q=new primitives.common.Point(e,d.y);break;case 2:q=new primitives.common.Point(d.x,l);break;case 3:q=d.centerPoint()}f[g]=new b(new primitives.common.Rect(q.x,q.y,m,n));a.quadrants[c]=g;g+=1;return s}var e=-1,f=[],g=0;return{addPoint:function(h){if(-1==e){var i=new b(new primitives.common.Rect(h.x-400,
h.y-400,1200,1200));f[g]=i;e=g;g+=1}else for(;!f[e].position.contains(h);){var i=h,k=f[e].position;k.contains(i.x,i.y)||(i.x<k.x?i.y<k.y?c(3):c(1):i.y<k.y?c(2):c(0))}for(i=f[e];null==i.points||10<=i.points.length;){k=i.position;if(null!=i.points&&k.width>a){for(var j=i,l=j.position,m=l.horizontalCenter(),l=l.verticalCenter(),n=0,s=j.points.length;n<s;n+=1){var q=j.points[n],p=null,p=q.x<m?q.y<l?0:2:q.y<l?1:3,r=j.quadrants[p];null==r&&(r=d(j,p));f[r].points.push(q)}j.points=null}j=null;j=h.x<k.horizontalCenter()?
h.y<k.verticalCenter()?0:2:h.y<k.verticalCenter()?1:3;k=i.quadrants[j];null==k&&(k=d(i,j));i=f[k]}i.points.push(h)},loopArea:function(a,b,c){if(null!=c)for(var d=[e];0<d.length;){for(var g=[],m=0,n=d.length;m<n;m+=1){var s=f[d[m]];if(null!=s&&s.position.overlaps(b))if(null==s.points)for(var q=0;4>q;q+=1)g.push(s.quadrants[q]);else for(var q=0,p=s.points.length;q<p;q+=1){var r=s.points[q];b.contains(r)&&c.call(a,r)}}d=g}},validate:function(){for(var a=0;a<f.length;a+=1){var b=f[a];if(null!=b.points)for(var c=
0;c<b.points.length;c+=1)if(!b.position.contains(b.points[c]))return!1;for(c=0;4>c;c+=1){var d=b.quadrants[c];if(null!=d&&!b.position.overlaps(f[d].position))return!1}}return!0}}};
primitives.common.pile=function(){function a(a,b,c,g){this.context=c;this.from=a;this.to=b;this.offset=null;this.direction=g}function b(a,c,f,g,h){if(a>=c.length)return 0;if(f.hasOwnProperty(a))return f[a];for(var i=c[a],k=b(a+1,c,f,g,h),j=a+1;j<c.length&&!(c[j].from>=i.to);)j+=1;c=1+b(j,c,f,g,h);c>k?(f[a]=c,g[a]=j,h[a]=!0):(f[a]=k,g[a]=a+1,h[a]=!1);return f[a]}var c=[];return{add:function(b,e,f){b<e?c.push(new a(b,e,f,1)):c.push(new a(e,b,f,-1))},resolve:function(a,e){var f,g,h,i,k,j,l=0;if(null!=
e){i=c.slice(0);i.sort(function(a,b){return a.from-b.from});for(k=[];0<i.length;){f={};g={};h={};b(0,i,f,g,h);f=[];k[l]=[];for(j=0;g.hasOwnProperty(j);)h[j]&&(f.push(j),k[l].push(i[j])),j=g[j];for(j=f.length-1;0<=j;j-=1)i.splice(f[j],1);l+=1}for(h=0;h<l;h+=1){f=k[h];for(j=0;j<f.length;j+=1)if(g=f[j],e.call(a,g.from,g.to,g.context,h,l,g.direction))return l}}return l}}};
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,k,j,l,m,n,s,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];k=d.length;j=e.length;i=h=0;s=m=n=l=null;0<k&&(l=d[h],n=!b?l:b(l));0<j&&(m=e[i],s=!b?m:b(m));for(q=null;h<k||i<j;)if(h>=k){if(!c||q!=m)f.push(m),q=m;i+=1;i<j&&(m=e[i],s=!b?m:b(m))}else if(i>=j){if(!c||q!=l)f.push(l),q=l;h+=1;h<k&&(l=d[h],n=!b?l:b(l))}else if(n<s){if(!c||q!=l)f.push(l),q=l;h+=1;h<k&&(l=d[h],n=!b?l:b(l))}else{if(!c||q!=m)f.push(m),
q=m;i+=1;i<j&&(m=e[i],s=!b?m:b(m))}d=f}}return d};
...
{},k={};primitives.common.isObject(a)&&(f=primitives.common.cloneObject(a.nodes,!0),g=primitives.common.cloneObject(a.parents,!0),h=primitives.common.cloneObject(a.children,!1),i=primitives.common.cloneObject(a.roots,!1),k=primitives.common.cloneObject(a.rootChildren,!0));return{loop:function(a,b){var c;if(null!=b)for(c in f)if(f.hasOwnProperty(c)&&b.call(a,c,f[c]))break},loopLevels:function(a,b,c){var d=0,e=[],g,i,r,w,x;switch(arguments.length){case 2:i=b;break;case 3:g=b,i=c}if(null!=i){if(null==
g)for(r in k)k.hasOwnProperty(r)&&(e=e.concat(k[r]));else null!=h[g]&&(e=e.concat(h[g]));for(;0<e.length;){r=[];w=0;for(x=e.length;w<x;w+=1)switch(g=e[w],i.call(a,g,f[g],d)){case 1:r=[];break;case 2:break;default:null!=h[g]&&(r=r.concat(h[g]))}e=r;d+=1}}},loopParents:function(a,b,c,d){if(null!=f[b]&&null!=c&&!(!0===d&&c.call(a,b,f[b])))for(;null!=(b=g[b])&&!c.call(a,b,f[b]););},loopChildren:b,loopChildrenRange:function(a,b,c,d,e){var g;if(null!=f[b]&&(b=h[b],null!=b))if(c<d){c=Math.max(c,0);d=Math.min(d,
b.length-1);for(g=c;g<=d&&!(c=b[g],e.call(a,c,f[c],g,NaN));g+=1);}else{c=Math.min(c,b.length-1);d=Math.max(0,d);for(g=c;g>=d&&!(c=b[g],e.call(a,c,f[c],g,NaN));g-=1);}},loopChildrenReversed:function(a,b,c){var d,e,g;if(null!=f[b]&&(b=h[b],g=b.length-1,null!=b))for(e=g;0<=e&&!(d=b[e],c.call(a,d,f[d],e,g));e-=1);},loopPostOrder:function(a,b){var c=[],d,e,i;if(null!=b){for(d in k)k.hasOwnProperty(d)&&(c=c.concat(k[d]));for(;0<c.length;)if(d=c[c.length-1],d!=e&&null!=(i=h[d]))for(d=i.length-1;0<=d;d-=
1)c.push(i[d]);else if(c.pop(),e=g[d],b.call(a,d,f[d],e,f[e]))break}},loopPreOrder:function(a,b){var c=[],d,e,i,p;if(null!=b){for(d in k)k.hasOwnProperty(d)&&(c=c.concat(k[d]));for(;0<c.length;){d=c[c.length-1];if(d!=i&&(e=g[d],b.call(a,d,f[d],e,f[e])))break;if(d!=i&&null!=(p=h[d]))for(d=p.length-1;0<=d;d-=1)c.push(p[d]);else c.pop(),i=g[d]}}},loopEulerWalk:function(a,b){var c=[],d,e=[],i=0,p,r,w;if(null!=b){for(d in k)if(k.hasOwnProperty(d)){w=k[d];p=0;for(i=w.length;p<i;p+=1)c.push(w[p]),e.push(0)}for(;0<
c.length;){p=c.length-1;d=c[p];i=e[p];if(b.call(a,d,f[d],i))break;if(d!=r&&null!=(w=h[d]))for(p=w.length-1;0<=p;p-=1)c.push(w[p]),e.push(i+1),0<p&&(c.push(d),e.push(i));else c.pop(),e.pop(),r=g[d]}}},loopNeighbours:function(a,b,c,d){var g={},h=[b],i,k=0;if(null!=d&&f.hasOwnProperty(b))for(g[b]=!0;0<h.length;){i=[];for(var b=0,w=h.length;b<w;b+=1){var x=h[b];if(0<k&&d.call(a,x,f[x],k))return;k<c&&e(this,x,function(a){g.hasOwnProperty(a)||(i.push(a),g[a]=!0)})}h=i;k+=1}},zipUp:function(a,b,c,d){var e,
f;if(null!=d)for(;null!=b&&null!=c&&b!=c;){e=g[b];f=g[c];if(d.call(a,b,e,c,f))break;b=e;c=f}},parentid:c,parent:function(a){var b=null;null!=g[a]&&(b=f[g[a]]);return b},adopt:function(a,b){if(null!=f[a]&&null!=f[b])if(a!=b)i.hasOwnProperty(b)&&(d(k[i[b]],b)||delete k[i[b]],delete i[b]),g.hasOwnProperty(b)&&(d(h[g[b]],b)||delete h[g[b]]),g[b]=a,null!=h[a]?h[a].push(b):h[a]=[b];else throw"Item cannot be parent of itself!";else throw"Both parent and child should be in hierarchy!";},moveChildren:function(a,
c){null!=f[a]&&(null!=f[c]&&a!=c)&&null!=h[a]&&(b(this,a,function(a){g[a]=c}),h[c]=null!=h[c]?h[c].concat(h[a]):h[a],delete h[a])},node:function(a){return f[a]},add:function(a,b,c,d){var e;if(null!=f[b])throw"Node already exists";if(null!=b&&(null!=c&&null==f[b])&&(null!=f[a]?(g[b]=a,null!=h[a]?null==d?h[a].push(b):h[a].splice(d,0,b):h[a]=[b]):(i[b]=a,null!=k[a]?null==d?k[a].push(b):k[a].splice(d,0,b):k[a]=[b]),f[b]=c,null!=k[b])){h[b]=k[b];delete k[b];d=h[b];a=0;for(c=d.length;a<c;a+=1)e=d[a],delete i[e],
g[e]=b}},insert:function(a,c,d){null!=f[a]&&(null!=c&&null==f[c]&&null!=d)&&(f[c]=d,null!=h[a]&&(h[c]=h[a]),h[a]=[c],b(this,c,function(a){g[a]=c}),g[c]=a)},hasNodes:function(){return!primitives.common.isEmptyObject(k)},hasChildren:function(a){return null!=h[a]},countChildren:function(a){return null!=h[a]?h[a].length:0},countSiblings:function(a){a=c(a);return null!=a?h[a].length:0},indexOf:function(a){var b=c(a);return null!=b?primitives.common.indexOf(h[b],a):null},getChild:function(a,b){var c=null,
...
e-1,h=c(f,g);f<g+1;){var i=c(f+1,g),k=c(f,g-1);if(i<k){if(i>=h)break;f+=1;h=i}else{if(k>=h)break;g-=1;h=k}}return[f,g-1,e-1]};
...
n[m].priority<=b.priority:n[m].priority>=b.priority))m=b.key;d=f}}function i(b,c){b.degree+=1;e(c);var f=n[b.child];if(null!=f){if(d(f,c),a?f.priority<c.priority:f.priority>c.priority)b.child=c.key}else b.child=c.key;c.parent=b.key}function k(b,c){var d=n[b];if(a?d.priority>c:d.priority<c)throw"Priority increase is not supported";d.priority=c;if(null!=d.parent){var e=n[d.parent];if(a?e.priority<d.priority:e.priority>d.priority)j(e,d),l(e)}if(a?n[m].priority<d.priority:n[m].priority>d.priority)m=d.key}
function j(a,b){b.marked=!1;b.parent=null;b.right==b.key?a.child=null:(a.child=b.right,e(b));a.degree-=1;d(n[m],b)}function l(a){if(null!=a.parent)if(a.marked){var b=n[a.parent];j(b,a);l(b)}else a.marked=!0}var m=null,n={};return{add:function(b,e,f){if(n.hasOwnProperty(b))throw"Duplicate keys are not supported!";e=new c(b,e,f);n[b]=e;if(null==m)e.left=b,m=e.right=b;else if(f=n[m],d(f,e),a?f.priority<e.priority:f.priority>e.priority)m=b},getPriority:function(a){var b=null;n.hasOwnProperty(a)&&(b=n[a].priority);
return b},setPriority:k,heapRoot:f,extractRoot:g,deleteKey:function(b){k(b,a?Infinity:-1);g()},validate:function(){var a=0,b;for(b in n)if(n.hasOwnProperty(b)){var c=n[b],a=a+1;if(null!=c.child){if(!n.hasOwnProperty(c.child))throw"Child does not exists";var d=n[c.child];if(d.parent!=c.key)throw"Child references wrong parent";}if(null!=c.parent&&!n.hasOwnProperty(c.parent))throw"Parent does not exists";if(null!=c.left){if(!n.hasOwnProperty(c.left))throw"Left does not exists";d=n[c.left];if(d.right!=
...
primitives.common.FamilyMargins=function(){function a(a,c,d,e){this.left=a;this.right=c;this.leftIndex=d;this.rightIndex=e}this.items=[];this.add=function(b,c,d,e){switch(arguments.length){case 2:this.items.push(new a(-b/2,b/2,c,c));break;case 4:this.items.push(new a(b,c,d,e))}};this.merge=function(b,c){for(var d=this.getDistanceTo(b),e=0,f=0,g=this.items.length,h=b.items.length,i=Math.min(g,h),k=Math.max(g,h),j=0;j<i;j+=1){var l=this.items[g-1-j],m=b.items[h-1-j];0===j&&(f=l.right-l.left+(d||0)+
(c||0)+m.right-m.left,e=f/2+l.left,f=f/2-m.right);l.left-=e;l.right=m.right+f;l.rightIndex=m.rightIndex;this.items[k-1-j]=l}for(j=i;j<k;j+=1)l=this.items[g-1-j],m=b.items[h-1-j],null==l?this.items[k-1-j]=new a(m.left+f,m.right+f,m.leftIndex,m.rightIndex):(l.left-=e,l.right-=e);return d};this.attach=function(b,c){for(var d=this.getDistanceTo(b),e=c||0,f=this.items.length,g=b.items.length,h=Math.min(f,g),i=Math.max(f,g),k=0;k<h;k+=1){var j=this.items[f-1-k],l=b.items[g-1-k];0===k&&(e=j.right+(d||0)+
(c||0)-l.left);j.right=l.right+e;j.rightIndex=l.rightIndex;this.items[i-1-k]=j}for(k=h;k<i;k+=1)j=this.items[f-1-k],null==j&&(l=b.items[g-1-k],this.items[i-1-k]=new a(l.left+e,l.right+e,l.leftIndex,l.rightIndex));return d};this.getDistanceTo=function(a){var c=null,d=0,e=this.items.length,f=a.items.length,g=Math.min(e,f);if(0<g){for(var h=0;h<g;h+=1){var i=this.items[e-1-h],k=a.items[f-1-h];0===h?c=d=i.right-k.left:i.rightIndex<k.leftIndex&&(c=Math.max(c,i.right-k.left))}c-=d}return c};this.loop=function(a,
...
primitives.common.FamilyAlignment=function(a,b,c,d){function e(a,b){var c=a[b];null==c&&(c=new primitives.common.FamilyMargins,a[b]=c);return c}function f(a,b,c,d,e,f,g,i){var r=f,w=f;c.loopSiblings(this,b,function(a){a=g.getItemPosition(a);r=Math.min(r,a);w=Math.max(w,a)});for(var x=f-1;x>=r;x-=1){var t=g.getItemAtPosition(d,x);if(!a.hasOwnProperty(t)){var u=g.getItemAtPosition(d,x+1);a[t]=a[u]-(h[t]/2+(i[u]||0)+h[u]/2)}}for(x=f+1;x<=w;x+=1)t=g.getItemAtPosition(d,x),a.hasOwnProperty(t)||(u=g.getItemAtPosition(d,
x-1),a[t]=a[u]+(h[u]/2+(i[t]||0)+h[t]/2));t=g.getItemAtPosition(d,r);u=a[t]-h[t]/2;t=g.getItemAtPosition(d,w);u+=a[t]+h[t]/2;u/=2;w=r=null;c.loopNonSiblings(this,b,function(a){a=g.getItemPosition(a);r=null!=r?Math.min(r,a):a;w=null!=w?Math.max(w,a):a});c=0;for(x=r;x<=w;x+=1)b=g.getItemAtPosition(e,x),c+=h[b],x>r&&(c+=i[b]||0);x=u-c/2;b=g.getItemAtPosition(e,r);a.hasOwnProperty(b)||(a[b]=x+h[b]/2);for(x=r+1;x<=w;x+=1)b=g.getItemAtPosition(e,x),a.hasOwnProperty(b)||(u=g.getItemAtPosition(e,x-1),a[b]=
a[u]+(h[u]/2+(i[b]||0)+h[b]/2))}var g,h={},i;null!=d&&c.loopItems(this,function(b,c){h[b]=d.call(a,b,c)});i=function(a,b){var c={},d={},f=null;b.loopLevelsReversed(this,function(g){var i=new primitives.common.FamilyMargins;null!=f&&(f.add(0,Number.MAX_VALUE),i.merge(f,0));var p=f=i;b.loopLevelItems(this,g,function(f,g,i){var n=e(d,f);n.add(h[f],i);switch(a.countParents(f)){case 0:null!=p&&(c[f]=p.attach(n));break;case 1:a.loopParents(this,f,function(b){b=e(d,b);c[f]=b.merge(n);p=b;return a.BREAK});
break;default:var q=0,s=null,v=null,y={};a.loopParents(this,f,function(c,d,e){if(0<e)return a.BREAK;q+=h[c];d=b.getItemPosition(c);s=null==s?d:Math.min(s,d);v=null==v?d:Math.max(v,d);y[d]=c});g=-q/2;for(i=s;i<=v;i+=1){var A=y[i],g=g+h[A]/2,B=e(d,A);B.attach(n,-g);p=B;g+=h[A]/2}}})});return c}(b,c);g=function(a,b,c){var d={},e=primitives.common.getFamilyUnits(a),g={};b.loopLevels(this,function(a){b.loopLevelItems(this,a,function(i,k,w){if(!d.hasOwnProperty(i)){k=0;if(0===w)null!=c[i]&&(k+=c[i]+h[i]/
2);else var x=b.getItemAtPosition(a,w-1),k=k+(d[x]+h[x]/2+(c[i]||0)+h[i]/2);d[i]=k}k=e[i];if(null!=k)for(x=0;x<k.length;x+=1){var t=k[x];g.hasOwnProperty(t.id)||(g[t.id]=!0,f(d,i,t,a,a+1,w,b,c))}})});return d}(b,c,i);return{getOffset:function(a){return g[a]}}};
primitives.common.family=function(a){function b(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e,b[e]))break}function c(a,b){var c=!1;null!=v[a]&&null!=v[a][b]&&(delete v[a][b],y[a]-=1,delete A[b][a],B[b]-=1,y[a]||(delete v[a],delete y[a]),A[b]||(delete A[b],delete B[b],null==u[null]&&(u[null]={},z[null]=0),u[null][b]=!0,z[null]+=1),c=!0);return c}function d(a,b){var c;if(null!=b)for(c in C)if(C.hasOwnProperty(c)&&b.call(a,c,C[c]))break}function e(a,c,d,e){for(var f,
g,h={},i=0,j=!0;j;){f={};j=!1;for(g in d)if(d.hasOwnProperty(g)&&!h[g])switch(h[g]=!0,e.call(a,g,C[g],i)){case 1:f={};j=!1;break;case 2:break;default:b(this,c,g,function(a){h[a]||(j=f[a]=!0)})}d=f;i+=1}}function f(a,b,c){null!=c&&null!=b&&(null!=C[b]&&null!=v[b])&&e(a,v,v[b],c)}function g(a,b,c){null!=c&&null!=b&&(null!=C[b]&&null!=A[b])&&e(a,A,A[b],c)}function h(a,c,d,e,f,g){var h,i,j,k;if(null!=g){c=[];i={};for(h in C)C.hasOwnProperty(h)&&(i[h]=d[h]||0,i[h]||c.push(h));for(k=0;0<c.length;){j=[];
d=0;for(f=c.length;d<f;d+=1){h=c[d];if(g.call(a,h,C[h],k)){j=[];break}k+=1;b(this,e,h,function(a){i[a]-=1;0===i[a]&&j.push(a)})}c=j}}}function i(a,b){h(a,A,B,v,y,b)}function k(a,b){h(a,v,y,A,B,b)}function j(a,b,c,d,e,f,g,h,i){var j=!1,k,l;if(null!=C[a]&&null!=g[a]){j=!0;if(i){i=0;for(k=b.length;i<k;i+=1)if(l=b[i],null==C[l]||null==g[a][l])j=!1}if(j&&(null!=d&&(C[c]=d),null!=C[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},h[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,h[a]+=1);i=0;for(k=b.length;i<
k;i+=1)l=b[i],c!=l&&(null!=g[a][l]&&(delete g[a][l],h[a]-=1),null!=e[l][a]&&(delete e[l][a],f[l]-=1),e[l][c]||(e[l][c]=!0,f[l]+=1),g[c][l]||(g[c][l]=!0,h[c]+=1))}}return j}function l(a,b,c,d){return j(a,b,c,d,A,B,v,y,!0)}function m(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function n(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function s(a){var c=primitives.common.graph(),d,e,f,g,h,i,j,k,l={};for(d in a)a.hasOwnProperty(d)&&
b(this,v,d,function(d){if(!l.hasOwnProperty(d)){l[d]=!0;e=[];b(this,A,d,function(a){e.push(a)});f=0;for(h=e.length;f<h-1;f+=1)if(i=e[f],a.hasOwnProperty(i))for(g=f+1;g<h;g+=1)if(j=e[g],a.hasOwnProperty(j)){k=Math.abs(a[i].children.length-a[j].children.length);var m=c.edge(i,j);null==m&&(m=new n(k),c.addEdge(i,j,m));m.items.push(d);m.weight+=1}}});return c}function q(a,b){this.parentid=a;this.childid=b;this.key=a+","+b}function p(a,b){this.from=a;this.to=b;this.distance=0}function r(a){return y[a]||
0}function w(a){return B[a]||0}function x(a){var b=null,a=v[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}function t(){return primitives.common.family({roots:u,rootsCount:z,children:v,childrenCount:y,parents:A,parentsCount:B,nodes:C})}var u={},z={},v={},y={},A={},B={},C={};primitives.common.isObject(a)&&(u=primitives.common.cloneObject(a.roots,!1),z=primitives.common.cloneObject(a.rootsCount,!0),v=primitives.common.cloneObject(a.children,!1),y=primitives.common.cloneObject(a.childrenCount,
!0),A=primitives.common.cloneObject(a.parents,!1),B=primitives.common.cloneObject(a.parentsCount,!0),C=primitives.common.cloneObject(a.nodes,!0));return{add:function(a,c,d){var e,f,g={};if(!a||0===a.length)a=[null];if(null==C[c]&&null!=d){C[c]=d;d=0;for(e=a.length;d<e;d+=1)f=a[d],null==g[f]&&f!=c&&(g[f]=!0,null!=C[f]?(null==A[c]&&(A[c]={},B[c]=0),A[c][f]||(A[c][f]=!0,B[c]+=1),null==v[f]&&(v[f]={},y[f]=0),v[f][c]||(v[f][c]=!0,y[f]+=1)):(null==u[f]&&(u[f]={},z[f]=0),u[f][c]||(u[f][c]=!0,z[f]+=1)));
null!=u[c]&&(v[c]=u[c],y[c]=z[c],delete u[c],delete z[c],b(this,v,c,function(a){null==A[a]&&(A[a]={},B[a]=0);A[a][c]||(A[a][c]=!0,B[a]+=1)}))}},adopt:function(a,b){var c,d,e;if(null!=C[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==A[b]&&(A[b]={},B[b]=0),e!=b&&null!=C[e])A[b][e]||(A[b][e]=!0,B[b]+=1),null==v[e]&&(v[e]={},y[e]=0),v[e][b]||(v[e][b]=!0,y[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}else throw"Child should be in hierarchy!";},bundleChildren:l,
bundleParents:function(a,b,c,d){return j(a,b,c,d,v,y,A,B,!0)},optimizeReferences:function(a){var c={},d={},e={},g,h,i,k,l,n;l=0;var p=10,q;if(null!=a){for(g in C)l+=1,C.hasOwnProperty(g)&&(h=new m,b(this,v,g,function(a){h.children.push(a);h.childrenHash[a]=!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),e[h.id]=h);for(p=Math.pow(10,l.toString().length);!primitives.common.isEmptyObject(e);){i={};q={};k=s(e);for(g in e)e.hasOwnProperty(g)&&(l=e[g],l.processed||(n=k.getSpanningTree(g,function(a){return a.weight*
p+p-a.difference}),n.loopLevels(this,function(b,g){e[b].processed=!0;n.loopChildren(this,b,function(h,l){var n=k.edge(b,h),p=null,r,s,u,t,w,x;e[h].processed=!0;if(1<n.weight){s=n.items.join(",");if(c.hasOwnProperty(s))p=c[s];else{r=a();C[r.id]=r;p=new m;p.id=r.id;p.key=s;s=0;for(u=n.items.length;s<u;s+=1)x=n.items[s],p.children.push(x),p.childrenHash[x]=!0,q[x]=!0;p.children.sort();c[p.key]=p;d[p.id]=p;i[p.id]=p;q[p.id]=p;t=p.children.slice(0);f(this,g.replacementItem||b,function(a){!p.childrenHash[a]&&
null!=d[a]&&(w=!0,f(this,a,function(a){if(!p.childrenHash[a])return w=!1,1;if(!q.hasOwnProperty(a))return 2}),w&&t.push(a));return 2});j(g.replacementItem||b,t,p.id,r,A,B,v,y,!1);if(1>=(y[b]||0)&&null==g.replacementItem)g.replacementItem=p.id}if(p.id!=h&&(t=p.children.slice(0),f(this,l.replacementItem||h,function(a){null!=d[a]&&!p.childrenHash[a]&&(w=!0,f(this,a,function(a){return!p.childrenHash[a]?(w=!1,1):(q.hasOwnProperty(a),2)}),w&&t.push(a));return 2}),j(l.replacementItem||h,t,p.id,null,A,B,
v,y,!1),1>=(y[h]||0)&&null==l.replacementItem))l.replacementItem=p.id}})})));e=i}}},eliminateManyToMany:function(a){var c,d;for(c in v)v.hasOwnProperty(c)&&1<(y[c]||0)&&b(this,v,c,function(b){if(1<(B[b]||0))d=a(),l(c,[b],d.id,d)})},getPlanarFamily:function(a){var b=new primitives.common.family,c,d;a.loopLevels(this,function(e){var g=new primitives.common.LinkedHashItems,h={},i={},j=[];a.loopLevelItems(this,e,function(b){f(this,b,function(c){var d=a.getItemPosition(c),e=new q(b,c);i[e.key]=e;var f=
[];g.isEmpty()?g.add(d,[e]):(g.iterateBack(function(a,c){if(c<d)return g.insertAfter(c,d,[e]),!0;if(c==d)return a.push(e),!0;for(var h=0,i=a.length;h<i;h+=1){var j=a[h];j.parentid!=b&&f.push(j)}}),g.startKey()>d&&g.unshift(d,[e]));h[e.key]=f;for(var c=0,j=f.length;c<j;c+=1)h[f[c].key].push(e);return 2});if(1==r(b)){var c=x(b);1==w(c)&&(c=new q(b,c),j.push(c.key))}});var e=[],k,l;for(l in h){k=h[l];var n=k.length;null!=e[n]?e[n].push(l):e[n]=[l]}n={};e.unshift(j);for(var m=0,p=e.length;m<p;m+=1){var s=
e[m];if(null!=s){c=0;for(d=s.length;c<d;c+=1)if(l=s[c],!n.hasOwnProperty(l)){n[l]=!0;k=i[l];null==b.node(k.parentid)&&b.add(null,k.parentid,{});null==b.node(k.childid)?b.add([k.parentid],k.childid,{}):b.adopt([k.parentid],k.childid);k=h[l];l=0;for(var t=k.length;l<t;l+=1)n[k[l].key]=!0}}}});return b},getFamilyWithoutGrandParentsRelations:function(){var a=new primitives.common.family,c={},e=[],f=0,g;for(g in A)A.hasOwnProperty(g)&&b(this,A,g,function(a){var b=c[g];null==b&&(b={},c[g]=b);b.hasOwnProperty(a)||
(b=new p(g,a,f),e.push(b),c[g][a]=b)});for(;0<e.length;){for(var h=[],f=f+1,i=0,j=e.length;i<j;i+=1){var k=e[i];g=k.to;A.hasOwnProperty(g)&&b(this,A,g,function(a){var b=c[k.from];null==b&&(b={},c[k.from]=b);if(b.hasOwnProperty(a))b[a].distance=f;else{var d=new p(g,a,f);h.push(d);b[a]=d}})}e=h}d(this,function(d,e){var f=[];b(this,A,d,function(a){0===c[d][a].distance&&f.push(a)});a.add(f,d,e)});return a},getGraph:function(){var a=primitives.common.graph(),c;for(c in v)v.hasOwnProperty(c)&&b(this,v,
c,function(b){var d=a.edge(c,b);null==d&&(d=new n({}),a.addEdge(c,b,d))});return a},removeNode:function(a){null!=C[a]&&(b(this,v,a,function(b){delete A[b][a];B[b]-=1;B[b]||(delete A[b],delete B[b],null==u[null]&&(u[null]={},z[null]=0),u[null][b]||(u[null][b]=!0,z[null]+=1))}),b(this,A,a,function(b){delete v[b][a];y[b]-=1;y[b]||(delete v[b],delete y[b])}),null!=u[null]&&null!=u[null][a]&&(delete u[null][a],z[null]-=1,z[null]||(delete u[null],delete z[null])),delete v[a],delete y[a],delete A[a],delete B[a],
delete C[a])},removeRelation:function(a,b){var d=!1;null!=C[a]&&null!=C[b]&&(d=c(a,b)||c(b,a));return d},node:function(a){return C[a]},loop:d,loopLevels:function(a,c,d){function e(){this.items={};this.minimumLevel=null}function f(a,b,c){var d=m[b];d||(d=new e,m[b]=d);d.addItemToLevel(a,c);u=null==u?c:Math.min(u,c);n[a]=c;j[a]=!0}var g=[],h={},j={},l=[],n={},m={},p,s,q,r,t,u=null;q=c?i:k;var w,x,y,z,B,T,aa,X;e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=
c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){q(this,function(a,b,c){g.push(a);h[a]=c});q=0;for(w=g.length;q<w;q+=1)if(p=g[q],null==j[p]){l.push(p);for(f(p,q,0);0<l.length;){B=z=y=null;T=!c;aa=[];p=0;for(r=l.length;p<r;p+=1)t=l[p],x=n[t],X=!1,c?(b(this,A,t,function(a){var b;if(!j[a]&&(X=!0,b=h[a],null==y||!T||y<b||y==b&&B>x-1))y=b,z=a,B=x-1,T=!0}),b(this,v,t,function(a){var b;if(!j[a]&&(X=!0,b=h[a],null==y||!T&&(y>b||y==b&&B<x+1)))y=b,z=a,B=x+1,T=!1})):
(b(this,v,t,function(a){var b;if(!j[a]&&(X=!0,b=h[a],null==y||T||y<b||y==b&&B<x+1))y=b,z=a,B=x+1,T=!1}),b(this,A,t,function(a){var b;if(!j[a]&&(X=!0,b=h[a],null==y||T&&(y>b||y==b&&B>x-1)))y=b,z=a,B=x-1,T=!0})),X&&aa.push(t);null!=z&&(aa.push(z),f(z,q,B));l=aa}}l=!0;for(c=u;l;){p={};l=!1;for(s in m)if(m.hasOwnProperty(s)&&(q=m[s],r=q.items[q.minimumLevel-u+c],null!=r)){p[s]=q;l=!0;q=0;for(w=r.length;q<w;q+=1)if(t=r[q],d.call(a,t,C[t],c-u))return l=!1,!0}m=p;c+=1}}},loopTopo:i,loopTopoReversed:k,loopChildren:f,
loopParents:g,findLargestRoot:function(){var a=null,b,c={},d={},e;b=null;k(this,function(f,h){c.hasOwnProperty(f)||(c[f]={},d[f]=0);c[f][f]=!0;d[f]+=1;e=!0;g(this,h.id,function(a){var b,g;e=!1;c.hasOwnProperty(a)||(c[a]={},d[a]=0);if(!d[a]&&1==B[f])c[a]=c[f],d[a]=d[f];else for(g in b=c[f],b)b.hasOwnProperty(g)&&(c[a][g]=!0,d[a]+=1);return 2});if(e&&(!b||d[f]>b))b=d[f],a=f});return a},loopRoots:function(a,b){var c=null,d,e=0,f={},h={},i,j={},l={},n,m,p,q,s,r,t;k(this,function(a,b){f.hasOwnProperty(a)||
(f[a]={},h[a]=0);f[a][a]=!0;h[a]+=1;i=!0;g(this,b.id,function(b){var c,d;i=!1;f.hasOwnProperty(b)||(f[b]={},h[b]=0);if(!h[b]&&1==B[a])f[b]=f[a],h[b]=h[a];else for(d in c=f[a],c)c.hasOwnProperty(d)&&!f[b][d]&&(f[b][d]=!0,h[b]+=1);return 2});i&&(j[a]=!0,e+=1)});q={};for(p in j)if(j.hasOwnProperty(p))for(m in d=f[p],d)d.hasOwnProperty(m)&&(q[m]||(q[m]=[]),q[m].push(p.toString()));for(;0<e;){d=null;for(n in j)if(j.hasOwnProperty(n)&&(!d||h[n]<d))d=h[n],c=n;if(null!=c){null!=b&&b.call(a,c,C[c]);d=f[c];
for(m in d)if(d.hasOwnProperty(m)&&!l[m]){p=q[m];r=0;for(t=p.length;r<t;r+=1)s=p[r],h[s]-=1;l[m]=!0}delete j[c];e-=1}}},hasNodes:function(){return!primitives.common.isEmptyObject(C)},hasCommonChild:function(a){var c=!1,d,e,f,g,h,i,j;d={};g=f=0;for(h=a.length;g<h;g+=1)i=a[g],null!=C[i]&&!d[i]&&(d[i]=!0,f+=1);e={};for(i in d)d.hasOwnProperty(i)&&b(this,v,i,function(a){e[a]=e[a]?e[a]+1:1});for(j in e)if(e.hasOwnProperty(j)&&null!=A[j]&&(B[j]||0)==e[j]&&e[j]==f){c=!0;break}return c},loopNeighbours:function(a,
b,c){var d={};null!=c&&(f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=2,g(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}),g(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=2,f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=!0,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}))},countChildren:r,countParents:w,firstParent:function(a){var b=null,a=A[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;
return null},firstChild:x,validate:function(a){function c(a){var b=0,d;if(null!=a)for(d in a)a.hasOwnProperty(d)&&(b+=1);return b}var e,f;d(this,function(c){b(this,v,c,function(b){if(!A.hasOwnProperty(b)||!A[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+c),!1});b(this,A,c,function(b){if(!v.hasOwnProperty(b)||!v[b].hasOwnProperty(c))return null!=a&&(a.message="Parent #"+b+" does not reference child #"+c),!1})});for(e in A)if(A.hasOwnProperty(e)){if((B[e]||
0)!=c(A[e]))return null!=a&&(a.message="Parents count for item #"+e+" missmatch."),!1;if(A.hasOwnProperty(e)&&!C.hasOwnProperty(e))return null!=a&&(a.message="Orphant parents for item #"+e),!1}for(f in v)if(v.hasOwnProperty(f)){if((y[f]||0)!=c(v[f]))return null!=a&&(a.message="Children count for item "+f+" missmatch."),!1;if(v.hasOwnProperty(f)&&!C.hasOwnProperty(f))return null!=a&&(a.message="Orphant children of item "+f),!1}for(f in u)if(u.hasOwnProperty(f)){if((z[f]||0)!=c(u[f]))return null!=a&&
(a.message="Root children count for item @"+f+" missmatch."),!1;b(this,u,f,function(b){if(!C.hasOwnProperty(b))return null!=a&&(a.message="Child #"+b+"of root #"+f+" does not exists."),!1})}return!0},hasLoops:function(){var a=t();i(this,function(b){a.removeNode(b)});return a.hasNodes()},clone:t,BREAK:1,SKIP:2}};
primitives.common.binarySearch=function(a,b,c,d){var e=null,f,c=c||0,g=d||a.length-1,h,i;if(0<a.length&&(i=a[c],e={index:c,item:i},d=b(i),0<d))if(f=Math.abs(d),i=a[g],d=b(i),0<=d)e={index:g,item:i};else{d=Math.abs(d);f>d&&(f=d,e={index:g,item:i});for(;c+1<g;)if(h=Math.round((c+g)/2),i=a[h],d=b(i),0===d){e={index:h,item:i};break}else 0<d?c=h:g=h,d=Math.abs(d),f>d&&(f=d,e={index:h,item:i})}return e};
primitives.common.graph=function(){function a(a,b,c,e){var f=[],l,m,n,s;f.push(b);c[b]=!0;if(null!=e)for(;0<f.length;){b=[];m=0;for(n=f.length;m<n;m+=1)for(s in l=f[m],e.call(a,l),l=d[l],l)l.hasOwnProperty(s)&&!c.hasOwnProperty(s)&&(c[s]=!0,b.push(s));f=b}}function b(a,b){var c=null,e,f,l,m=0,n=null;for(e in d)if(d.hasOwnProperty(e)){f=d[e];m=0;for(l in f)f.hasOwnProperty(l)&&(m+=b.call(a,f[l],e,l));if(m>n||null==n)c=e,n=m}return c}function c(a,c,i,k,j){var l={},m,n=[],s={},q=0,p,r,w,x,t,u;if(null!=
i&&null!=k&&(null==c&&(c=b(a,i)),null!=c)){k.call(a,c);l[c]=!0;q+=1;for(s[c]=null;0<q;){n=[];r=p=null;w={};for(m in l)if(l.hasOwnProperty(m)){x=d[m];c=!1;for(t in x)if(x.hasOwnProperty(t)&&!s.hasOwnProperty(t))switch(u=i.call(a,x[t],m,t),c=!0,j){case e:null==w[t]&&(w[t]=0);w[t]+=u;if(!r||w[t]>r)p=t,r=w[t];break;case f:if(w[t]=null==w[t]?u:Math.min(w[t],u),!r||w[t]<r)p=t,r=w[t]}c||n.push(m)}if(null==p)break;else l[p]=!0,q+=1,s[p]=!0,k.call(a,p);c=0;for(p=n.length;c<p;c+=1)delete l[n[c]],q-=1}}}var d=
...
e,b[e])},getSpanningTree:function(a,b){var c=primitives.common.tree(),e=primitives.common.FibonacciHeap(!0),f,l={},m,n,s,q;e.add(a,0,null);for(l[a]=null;null!=(f=e.extractRoot());){m=d[f.key];for(n in m)m.hasOwnProperty(n)&&!c.node(n)&&(s=null!=b?b(m[n]):m[n],q=e.getPriority(n),null==q?(e.add(n,s,null),l[n]=f.key.toString()):q<=s&&(e.setPriority(n,s),l[n]=f.key.toString()));c.add(l[f.key],f.key.toString(),{})}return c},getTotalWeightGrowthSequence:function(a,d,f){var k=b(a,d);c(a,k,d,f,e)},getMinimumWeightGrowthSequence:function(a,
b,d,e){c(a,b,d,e,f)},getShortestPath:function(a,b,c,e,f){var l=primitives.common.FibonacciHeap(!1),m={},n={},s,q,p={},r=0,w=0,m=0;for(q=c.length;m<q;m+=1)s=c[m],p.hasOwnProperty(s)||(r+=1,p[s]=!0);l.add(b,0,null);for(n[b]=null;null!=(b=l.extractRoot());){c=d[b.key];for(s in c)c.hasOwnProperty(s)&&(q=b.priority+(null!=e?e.call(a,c[s],b,s):1),m=l.getPriority(s),null!=m?m>q&&(l.setPriority(s,q),n[s]=b.key):n.hasOwnProperty(s)||(l.add(s,q,null),n[s]=b.key));if(p.hasOwnProperty(b.key)){m=[];for(c=b.key;null!=
c;)m.push(c),c=n[c];f.call(a,m,b.key);w+=1;if(w>=r)break}}}}};
...
primitives.common.DependencyManager=function(){var a={};return{register:function(b,c){return a[b]=c},resolve:function(b,c,d){var e=[],f=d||{};return function(){for(var d=Array.prototype.slice.call(arguments,0),h=0;h<b.length;h+=1){var i=b[h];e.push(a[i]&&""!==i?a[i]:d.shift())}e=e.concat(d);return c.apply(f||{},e)}}}};
...
f,g){var h=!1;0===d.length&&b.loopTopo(this,function(a,b){b.task=c.register(a,c.resolve(b.dependencies,b.factory)());d.push(b)});g&&console.log("-- process --");for(var i={},k=0,j=d.length;k<j;k+=1){var l=d[k],m=[];if(l.name==a||i.hasOwnProperty(l.name)){if(g)var n=performance.now();(h=l.task.process(g))&&b.loopChildren(this,l.name,function(a){i[a]=!0;g&&m.push(a);return b.SKIP});if(g)var s=performance.now();if(g){var q=Math.round(s-n,2);console.log(k+". "+l.name+(", "+q+" ms. ")+(h?" - forces: "+
m.toString():""))}}if(l.name==f)break}},getProcessDiagramConfig:function(){var a=new primitives.famdiagram.Config;0===d.length&&b.loopTopo(this,function(a,b){b.task=c.register(a,c.resolve(b.dependencies,b.factory)());d.push(b)});for(var f=0,g=d.length;f<g;f+=1){var h=d[f],i=new primitives.famdiagram.ItemConfig;i.id=h.name;i.title=primitives.common.splitCamelCaseName(h.name).join(" ");i.description=h.task.description||"";i.itemTitleColor=h.color;i.parents=[];b.loopParents(this,h.name,function(a){i.parents.push(a);
...
d.restore()};primitives.pdf.graphics.prototype.rightAngleLine=function(){};primitives.pdf.graphics.prototype.template=function(a,b,c,d,e,f,g,h,i,k,j,l,m){c=0;null!==m&&void 0!==m["border-width"]&&(c=this.getPxSize(m["border-width"]));a=new primitives.common.Rect(a+e,b+f,g-c,h-c);null==l&&(l=new primitives.common.RenderEventArgs);null!==j&&j(this._doc,a,l)};
...
["OptionsTask","defaultConfig"],primitives.orgdiagram.ConnectorsOptionTask,"#ffffff");a.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],primitives.famdiagram.ItemsOptionTask,"#ffffff");a.addTask("SpousesOptionTask",["OptionsTask","defaultItemConfig"],primitives.famdiagram.SpousesOptionTask,"#ffffff");a.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],primitives.orgdiagram.ItemsSizesOptionTask,"#ffffff");a.addTask("PrintPreviewOptionTask",
["OptionsTask","defaultConfig"],primitives.orgdiagram.PrintPreviewOptionTask,"#ffffff");a.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],primitives.orgdiagram.TemplatesOptionTask,"#ffffff");a.addTask("OrientationOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.OrientationOptionTask,"#ffffff");a.addTask("VisualTreeOptionTask",["OptionsTask"],primitives.famdiagram.VisualTreeOptionTask,"#ffffff");a.addTask("NormalizeOptionTask",
["OptionsTask","defaultConfig"],primitives.famdiagram.NormalizeOptionTask,"#ffffff");a.addTask("LinePaletteOptionTask",["OptionsTask","defaultPaletteItemConfig"],primitives.famdiagram.LinePaletteOptionTask,"#ffffff");a.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorItemOptionTask,"#ffffff");a.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.HighlightItemOptionTask,"#ffffff");a.addTask("SelectedItemsOptionTask",["OptionsTask"],
primitives.orgdiagram.SelectedItemsOptionTask,"#ffffff");a.addTask("SplitAnnotationsOptionTask",["OptionsTask"],primitives.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");a.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");a.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],primitives.orgdiagram.ShapeAnnotationOptionTask,
"#ffffff");a.addTask("ForegroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");a.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");a.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask",
"defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");a.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");a.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#ffffff");a.addTask("ScaleOptionTask",
["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#ffffff");a.addTask("IntervalsTask",["ItemsSizesOptionTask"],primitives.orgdiagram.IntervalsTask,"#00ffff");a.addTask("LogicalFamilyTask",["ItemsOptionTask"],primitives.famdiagram.LogicalFamilyTask,"#00ffff");a.addTask("LabelAnnotationOptionTask",["SplitAnnotationsOptionTask","LogicalFamilyTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationOptionTask,"#ffffff");a.addTask("LabelAnnotationTemplateOptionTask",
["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationTemplateOptionTask,"#ffffff");a.addTask("LabelAnnotationPlacementOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationPlacementOptionTask,"#ffffff");a.addTask("CombinedContextsTask",["ItemsOptionTask","LabelAnnotationOptionTask"],primitives.orgdiagram.CombinedContextsTask,"#00ffff");a.addTask("AddLabelAnnotationsTask",["LabelAnnotationPlacementOptionTask",
...
null);a.addDependency("foreground",2);a.addDependency("background",1);a.addTask("OptionsTask",["options"],primitives.orgdiagram.OptionsTask,"#000000");a.addTask("CalloutOptionTask",["OptionsTask","defaultConfig","defaultItemConfig"],primitives.orgdiagram.CalloutOptionTask,"#ffffff");a.addTask("ConnectorsOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ConnectorsOptionTask,"#ffffff");a.addTask("ItemsOptionTask",["OptionsTask","defaultItemConfig"],primitives.orgdiagram.ItemsOptionTask,
"#ffffff");a.addTask("ItemsSizesOptionTask",["OptionsTask","defaultConfig","defaultItemConfig","defaultButtonConfig"],primitives.orgdiagram.ItemsSizesOptionTask,"#ffffff");a.addTask("PrintPreviewOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.PrintPreviewOptionTask,"#ffffff");a.addTask("TemplatesOptionTask",["OptionsTask","defaultConfig","defaultButtonConfig","defaultTemplateConfig"],primitives.orgdiagram.TemplatesOptionTask,"#ffffff");a.addTask("OrientationOptionTask",["OptionsTask",
"defaultConfig"],primitives.orgdiagram.OrientationOptionTask,"#ffffff");a.addTask("VisualTreeOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.VisualTreeOptionTask,"#ffffff");a.addTask("CursorItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.CursorItemOptionTask,"#ffffff");a.addTask("HighlightItemOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.HighlightItemOptionTask,"#ffffff");a.addTask("SelectedItemsOptionTask",["OptionsTask"],primitives.orgdiagram.SelectedItemsOptionTask,
"#ffffff");a.addTask("SplitAnnotationsOptionTask",["OptionsTask"],primitives.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");a.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");a.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#ffffff");a.addTask("ForegroundHighlightPathAnnotationOptionTask",
["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","foreground"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");a.addTask("BackgroundHighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultHighlightPathAnnotationConfig","background"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#ffffff");a.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,
"#ffffff");a.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#ffffff");a.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#ffffff");a.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#ffffff");a.addTask("CombinedContextsTask",
...
primitives.connector.Controller.prototype._redraw=function(){var a=this.options,b,c,d=new primitives.common.Transform,e=this._graphics.activate("placeholder"),f=new primitives.common.PolylinesBuffer,g=this,h=primitives.orgdiagram.ConnectorAnnotationOffsetResolver();d.size=new primitives.common.Size(this._panelSize.width,this._panelSize.height);d.setOrientation(a.orientationType);if(null!=a.fromRectangle&&null!=a.toRectangle){var i=a.fromRectangle,k=a.toRectangle;d.transformRect(i.x,i.y,i.width,i.height,
!1,this,function(a,b,c,d){i=new primitives.common.Rect(a,b,c,d)});d.transformRect(k.x,k.y,k.width,k.height,!1,this,function(a,b,c,d){k=new primitives.common.Rect(a,b,c,d)});switch(a.connectorPlacementType){case 0:b=new primitives.common.ConnectorOffbeat;break;case 1:b=new primitives.common.ConnectorStraight}var j;d.transformRect(0,0,a.labelSize.width,a.labelSize.height,!1,this,function(a,b,c,d){j=new primitives.common.Size(c,d)});var l=null;d.transformRect(0,0,e.size.width,e.size.height,!1,this,function(a,
b,c,d){l=new primitives.common.Size(c,d)});var e=new primitives.common.PaletteItem({lineColor:a.color,lineWidth:a.lineWidth,lineType:a.lineType}),m=!primitives.common.isNullOrEmpty(a.label),i=(new primitives.common.Rect(i)).offset(a.offset),k=(new primitives.common.Rect(k)).offset(a.offset);b.draw(f,e,i,k,6*a.lineWidth,0,j,l,a.connectorShapeType,4,a.labelPlacementType,m,h,function(b){m&&null!=b&&(d.transformRect(b.x,b.y,b.width,b.height,!0,g,function(a,c,d,e){b=new primitives.common.Rect(a,c,d,e)}),
